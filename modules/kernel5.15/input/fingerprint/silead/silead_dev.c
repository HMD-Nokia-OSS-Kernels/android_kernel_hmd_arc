...
#elif defined ZCFG_KEYMAP_VALUE_UNSUPPORT_F11
static nav_keymap_t keymap[] = {
    { NAV_KEY_UP,       KEY_UP,         }, /* KEY_RESERVED, ignore this key */
    { NAV_KEY_DOWN,     KEY_DOWN,       },
    { NAV_KEY_RIGHT,    KEY_RIGHT,      },
...
#elif defined ZCFG_KEYMAP_VALUE_LONGPRESS
static nav_keymap_t keymap[] = {
...
#elif defined(ZCFG_SILEAD_UNSUPPORT_KEYMAP_VALUE)
static nav_keymap_t keymap[] = {
    { NAV_KEY_UP,       KEY_RESERVED,   }, /* KEY_RESERVED, ignore this key */
    { NAV_KEY_DOWN,     KEY_RESERVED,   },
    { NAV_KEY_RIGHT,    KEY_RESERVED,   },
...
static int silfp_keyevent(struct silfp_data	*fp_dev, struct fp_dev_key_t *pkey)
{
    ...
    if (IS_KEY_VALID(pkey->value)) {
        ...
        case NAV_KEY_CLICK_UP:
            ...
            break;
    #ifdef ZCFG_KEYMAP_LONGPRESS_SHUTWDOWN              //[zunyi] [xxw] If the key value is 7, Report the power cannot be shut down if you press and hold it

        case NAV_KEY_LONGPRESS:
            LOG_MSG_DEBUG(INFO_LOG,"pkey->value == %d,no event key value\n",pkey->value,__func__);
            return -1;
...
struct proc_ops silfp_class_node_ops = {
    //.owner  = THIS_MODULE,
};
