...
static int remap[8][4] = {
	{0,0,0,0},     			// 0: top   , left-down
	{1,0,0,1},			// 1: top   , right-down
	{1,1,0,0}, 			// 2: top   , right-up
	{0,1,0,1},			// 3: top   , left-up
	{1,0,1,0},			// 4: bottom, left-down
	{0,0,1,1},			// 5: bottom, right-down
	{0,1,1,0},			// 6: bottom, right-up
	{1,1,1,1}				// 7: bottom, left-up
};
...
#define TEMP_CALIBRATE_STATIC_THRESHOLD    100
...
#if defined(ZCFG_MIR3DA_LEVEL_X_Y)
