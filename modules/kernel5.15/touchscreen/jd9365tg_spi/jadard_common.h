...
#define JADARD_DRIVER_VER        "01.A0" /* MAJOR_VER.MINOR_VER */
...
#if defined(CONFIG_PROJ_S81_YIBOTONG)
#define JD_PROXIMITY_MODE          (JD_PROXIMITY_BACKLIGHT)
#else
...
extern int jadard_check_lcd(void);
extern char *vendor_fw;
#endif
