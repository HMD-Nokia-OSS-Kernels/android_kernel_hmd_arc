...
void himax_mcu_read_FW_ver(void)
{
	...
	zyt_info_s2("[TP] : ", "hx83102");
	#if defined(ZCFG_FM670L7_CF8_CD1402_HXCHIPSET)
		zyt_info_sx("[TP] : FW Version:",hx_s_ic_data->vendor_touch_cfg_ver);
	#else
		zyt_info_sx("[TP] : FW Version:",hx_s_ic_data->vendor_fw_ver);
	#endif
