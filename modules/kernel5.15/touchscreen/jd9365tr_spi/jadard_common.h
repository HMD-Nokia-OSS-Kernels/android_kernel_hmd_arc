...
#define JADARD_DRIVER_VER		 "01.60" /* MAJOR_VER.MINOR_VER_Heros modified */
...
#define TOUCHSCREEN_JADARD_MODULE
#define TOUCHSCREEN_JADARD_IC_JD9365TR
#define JD_FB
 ...
 */
/* #define JD_CONFIG_FB */
/* #define ZCFG_TP_NOT_USE_SUSPEND_RESUME_NODE */
