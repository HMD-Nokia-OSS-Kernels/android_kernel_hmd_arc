...
#define FTS_X_MAX_DISPLAY_DEFAULT           ZCFG_LCM_WIDTH
#else
#define FTS_X_MAX_DISPLAY_DEFAULT           720
#endif
#ifdef ZCFG_LCM_HEIGHT
#define FTS_Y_MAX_DISPLAY_DEFAULT           ZCFG_LCM_HEIGHT
#else
...
#ifdef TP_PROXIMITY_SENSOR_SHUB
    struct input_dev *ps_input_dev_shub;
    struct class *psensor_class;
    struct device *psensor_dev_shub;
#endif
