...
#define LCD_NAME_NT36528_BOE "lcd_nt36528_boe_mipi_hdp"
#define LCD_NAME_NT36528_KTI "lcd_nt36528_kti_mipi_hdp"
...
int32_t nvt_driver_init(void)
{
	...
	if (!ret && !(strstr(lcd_name, LCD_NAME_NT36528_BOE) || strstr(lcd_name, LCD_NAME_NT36528_KTI)))
	{
