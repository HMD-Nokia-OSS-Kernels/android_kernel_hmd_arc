 ...
 * default: disable
 */
#ifdef ZCFG_MK_ESDCHECK_EN_FT8057S
#define FTS_ESDCHECK_EN                         1
#else	
#define FTS_ESDCHECK_EN                         0
#endif

#ifdef ZCFG_MK_TP_GESTURE             //Prevent project opening gesture compilation errors [xxw]
 ...
 */
#if defined(ZCFG_FS311_WT_FT8057S_BUILTIN_FIRMWARE)
#define FTS_UPGRADE_FW_FILE                      ZCFG_FS311_WT_FT8057S_BUILTIN_FIRMWARE
#else
