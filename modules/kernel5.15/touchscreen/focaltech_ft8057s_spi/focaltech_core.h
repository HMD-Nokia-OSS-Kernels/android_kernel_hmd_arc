...
#define FTS_X_MAX_DISPLAY_DEFAULT           (ZCFG_LCM_WIDTH -1)
#else
#define FTS_X_MAX_DISPLAY_DEFAULT           (720 - 1)
#endif
#ifdef ZCFG_LCM_HEIGHT
#define FTS_Y_MAX_DISPLAY_DEFAULT           (ZCFG_LCM_HEIGHT -1)
#else
...
struct fts_ts_data {
    ...
    struct ts_resume_worker resume; /*modify touchscreen suspend/resume*/
    int irq;
    int log_level;
...
extern int check_ctp_chip(void);
extern int remove_ctp_chip(void);
