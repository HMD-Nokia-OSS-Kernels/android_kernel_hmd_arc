...
#define PROXIMITY_DEVICE_EIO	(-EIO)
#define PROXIMITY_DEVICE_EIO_ON	(0XAA)
#define PROXIMITY_DEVICE_EIO_OFF (0XBB)
#define PROXIMITY_DEVICE_EIO_IRQ (0XCC)

//#ifdef ZCFG_CTP_DISABLE_AVDD_AVEE
extern void set_proximity_device(int stu);
extern int get_proximity_device(void);
extern void set_proximity_calling_device(int stu);
extern int get_proximity_calling_device(void);
