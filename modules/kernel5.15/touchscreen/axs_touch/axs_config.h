...
#endif
#else
#define AXS_PROXIMITY_SENSOR_EN     0
#endif

#ifdef ZCFG_MK_TP_PROXIMITY_SHUB
#define AXS_PROXIMITY_SENSOR_SHUB_EN     1
#ifdef ZCFG_USE_INCELL_CTP
extern void incellctp_set_sprd_panel_phone_call_flag(bool enable);
#endif
#else
#define AXS_PROXIMITY_SENSOR_SHUB_EN     0
#endif
...
#ifdef ZCFG_AXS_DOWNLOAD_FIRMWARE_TO_PRAM //not have flash
...
#define AXS_AUTO_DOWNLOAD_FILE_TYPE		0 /*0:.i 1:.bin*/
#else
#define AXS_AUTO_DOWNLOAD_FILE_TYPE		1 /*0:.i 1:.bin*/
#endif

#ifdef ZCFG_AXS_DOWNLOAD_FIRMWARE_TO_FLASH //have flash
#define AXS_AUTO_UPGRADE_EN             1
#else
#define AXS_AUTO_UPGRADE_EN             0
#endif

#ifdef ZCFG_AXS_DOWNLOAD_FIRMWARE_TO_FLASH_NO_CHECK_VERSION
#define AXS_UPGRADE_CHECK_VERSION       0
#else
#define AXS_UPGRADE_CHECK_VERSION       1
#endif

#ifndef ZCFG_TP_AXS_BUS_SPI
