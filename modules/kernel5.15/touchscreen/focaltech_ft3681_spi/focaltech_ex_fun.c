...
static ssize_t fts_tp_suspend_show(struct device *dev,
...
static ssize_t fts_tp_suspend_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	unsigned int input;
	struct fts_ts_data *ts_data = fts_data;
...
static DEVICE_ATTR(ts_suspend, S_IRUGO | S_IWUSR,fts_tp_suspend_show,fts_tp_suspend_store); 
...
static struct attribute *fts_attributes[] = {
	...
	&dev_attr_ts_suspend.attr,//modify touchscreen suspend/resume
    NULL
};
