...
#include "mali_kbase_mem_profile_debugfs_buf_size_uapi.h"
...
#else
static struct notifier_block mali_e_show_mem_notifier;
#endif /* CONFIG_E_SHOW_MEM CONFIG_UNISOC_MM_ENHANCE_MEMINFO */
...
#if IS_ENABLED(CONFIG_OF)
static const struct of_device_id kbase_dt_ids[] = { { .compatible = "sprd,mali-gondul" },
