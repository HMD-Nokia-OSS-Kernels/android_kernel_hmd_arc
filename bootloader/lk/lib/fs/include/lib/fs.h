...
status_t fs_rename(const char *scr, const char *dest) __NONNULL();
...
struct fs_api {
    status_t (*format)(block_dev_desc_t *, const void *, disk_partition_t *);
    status_t (*fs_stat)(fscookie *, struct fs_stat *);

    status_t (*mount)(block_dev_desc_t *, fscookie **, disk_partition_t *);
    ...
    status_t (*rename)(fscookie *, const char *, const char *);
