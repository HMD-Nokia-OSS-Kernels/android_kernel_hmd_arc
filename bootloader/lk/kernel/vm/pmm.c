...
usage:
        dprintf(INFO,"usage:\n");
        dprintf(INFO,"%s arenas\n", argv[0].str);
        dprintf(INFO,"%s alloc <count>\n", argv[0].str);
        dprintf(INFO,"%s alloc_range <address> <count>\n", argv[0].str);
        dprintf(INFO,"%s alloc_kpages <count>\n", argv[0].str);
        dprintf(INFO,"%s alloc_contig <count> <alignment>\n", argv[0].str);
        dprintf(INFO,"%s dump_alloced\n", argv[0].str);
        dprintf(INFO,"%s free_alloced\n", argv[0].str);
        return ERR_GENERIC;
    }
    ...
    if (!strcmp(argv[1].str, "arenas")) {
        ...
        dprintf(INFO,"pmm_alloc_kpages returns %p\n", ptr);
        ...
        dprintf(INFO,"pmm_alloc_contiguous returns %zu, address 0x%lx\n", ret, pa);
        dprintf(INFO,"address %% align = 0x%lx\n", pa % argv[3].u);
        ...
        dprintf(INFO,"pmm_free returns %zu\n", err);
    } else {
