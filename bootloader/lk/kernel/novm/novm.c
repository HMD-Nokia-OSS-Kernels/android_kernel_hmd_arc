...
usage:
        dprintf(INFO,"usage:\n");
        dprintf(INFO,"\t%s info\n", argv[0].str);
        dprintf(INFO,"\t%s alloc <numberofpages> [arena bitmap]\n", argv[0].str);
        dprintf(INFO,"\t%s free <address> [numberofpages]\n", argv[0].str);
        return -1;
    }
