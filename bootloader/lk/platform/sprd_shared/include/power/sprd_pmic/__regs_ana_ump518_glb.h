...
#ifndef _UMP518_GLB_H
#define _UMP518_GLB_H
...
#define ANA_REG_GLB_DCXO_O_XTL_EN		(CTL_BASE_ANA_GLB + 0x02D8)
#define ANA_REG_GLB_AON_DATA_RAW		(CTL_BASE_ANA_GLB + 0x02DC)
#define ANA_REG_GLB_AON_DATA_SYNC		(CTL_BASE_ANA_GLB + 0x02E0)
...
#define ANA_REG_GLB_TSX_OUT_CTRL0		(CTL_BASE_ANA_GLB + 0x0328)
#define ANA_REG_GLB_TSX_OUT_CTRL1		(CTL_BASE_ANA_GLB + 0x032C)
#define ANA_REG_GLB_EXT_XTL_TX_CFG		(CTL_BASE_ANA_GLB + 0x0330)
...
#define ANA_REG_GLB_LDO_OCP_CTRL0		(CTL_BASE_ANA_GLB + 0x044C)
#define ANA_REG_GLB_LDO_OCP_CTRL1		(CTL_BASE_ANA_GLB + 0x0450)
#define ANA_REG_GLB_LDO_OCP_CTRL2		(CTL_BASE_ANA_GLB + 0x0454)
#define ANA_REG_GLB_LDO_OCP_FLAG0		(CTL_BASE_ANA_GLB + 0x0458)
#define ANA_REG_GLB_LDO_OCP_FLAG1		(CTL_BASE_ANA_GLB + 0x045C)
#define ANA_REG_GLB_DCDC_OCP_CTRL0		(CTL_BASE_ANA_GLB + 0x0460)
#define ANA_REG_GLB_DCDC_OCP_CTRL1		(CTL_BASE_ANA_GLB + 0x0464)
#define ANA_REG_GLB_DCDC_SCP_CTRL0		(CTL_BASE_ANA_GLB + 0x0468)
#define ANA_REG_GLB_DCDC_SCP_CTRL0		(CTL_BASE_ANA_GLB + 0x0468)
#define ANA_REG_GLB_DCDC_SCP_CTRL1		(CTL_BASE_ANA_GLB + 0x046C)
#define ANA_REG_GLB_DCDC_OCP_FLAG0		(CTL_BASE_ANA_GLB + 0x0470)
#define ANA_REG_GLB_DCDC_SCP_FLAG0		(CTL_BASE_ANA_GLB + 0x0474)
#define ANA_REG_GLB_SYS_LEVEL_EXCEPTION_CTRL	(CTL_BASE_ANA_GLB + 0x0478)
#define ANA_REG_GLB_BUCK_TOP_REG0		(CTL_BASE_ANA_GLB + 0x0500)
#define ANA_REG_GLB_BUCK_TOP_REG1		(CTL_BASE_ANA_GLB + 0x0504)
#define ANA_REG_GLB_BUCK_TOP_REG2		(CTL_BASE_ANA_GLB + 0x0508)
#define ANA_REG_GLB_AUX_TOP			(CTL_BASE_ANA_GLB + 0x050C)
#define ANA_REG_GLB_BG_OTP			(CTL_BASE_ANA_GLB + 0x0510)
#define ANA_REG_GLB_PWRON_TOP			(CTL_BASE_ANA_GLB + 0x0514)
#define ANA_REG_GLB_DCXO_TSENADC		(CTL_BASE_ANA_GLB + 0x0518)
#define ANA_REG_GLB_CHG_TOP			(CTL_BASE_ANA_GLB + 0x051C)
#define ANA_REG_GLB_BC1P2_G0			(CTL_BASE_ANA_GLB + 0x0520)
#define ANA_REG_GLB_BC1P2_G1			(CTL_BASE_ANA_GLB + 0x0524)
#define ANA_REG_GLB_FSTCHG_DET			(CTL_BASE_ANA_GLB + 0x0528)
#define ANA_REG_GLB_LDO_VBAT_REG0		(CTL_BASE_ANA_GLB + 0x052C)
#define ANA_REG_GLB_LDO_VBAT_REG1		(CTL_BASE_ANA_GLB + 0x0530)
#define ANA_REG_GLB_LDO_VBAT_REG2		(CTL_BASE_ANA_GLB + 0x0534)
#define ANA_REG_GLB_LDO_VBAT_REG3		(CTL_BASE_ANA_GLB + 0x0538)
#define ANA_REG_GLB_LDO_RTC_CTRL1		(CTL_BASE_ANA_GLB + 0x053C)
#define ANA_REG_GLB_LDO_DCDC			(CTL_BASE_ANA_GLB + 0x0540)
#define ANA_REG_GLB_TYPEC_DET_CURRENT_OFFSET	(CTL_BASE_ANA_GLB + 0x0544)
#define ANA_REG_GLB_LDO_XTL_EN13		(CTL_BASE_ANA_GLB + 0x0548)
#define ANA_REG_GLB_AUD_CLK_CTRL		(CTL_BASE_ANA_GLB + 0x054C)
#define ANA_REG_GLB_BUCK_TOP_REG3		(CTL_BASE_ANA_GLB + 0x0550)
#define ANA_REG_GLB_RTC_ALL_TOP			(CTL_BASE_ANA_GLB + 0x0554)
#define ANA_REG_GLB_CURRENT_DRV_TOP		(CTL_BASE_ANA_GLB + 0x0558)
...
#define BIT_EIC_DBNC_SOFT_RST			BIT(10)
...
#define BIT_LDO_VDDEMMCCORE_V_SW_SEL		BIT(8)
...
#define BIT_SLP_LDO_VDDLDO3_PD_EN		BIT(9)
...
#define BIT_SLP_LDO_VDDLDO3_LP_EN		BIT(9)
...
/* ANA_REG_GLB_DCXO_O_XTL_EN */

#define BIT_TSX_XO_O_EXT_XTL0_EN		BIT(5)
#define BIT_TSX_XO_O_EXT_XTL1_EN		BIT(4)
#define BIT_TSX_XO_O_EXT_XTL2_EN		BIT(3)
#define BIT_TSX_XO_O_EXT_XTL3_EN		BIT(2)
#define BIT_TSX_XO_O_EXT_XTL4_EN		BIT(1)
#define BIT_TSX_XO_O_EXT_XTL5_EN		BIT(0)

/* ANA_REG_GLB_AON_DATA_RAW */

#define BITS_AON_DATA(x)			(((x) & 0xFFFF))

/* ANA_REG_GLB_AON_DATA_SYNC */

#define BITS_AON_DATA_RTC(x)			(((x) & 0xFFFF))
...
/* ANA_REG_GLB_TSX_OUT_CTRL0 */

#define BIT_DCXO_26M_O_REF_OUT3_EXT_XTL3_EN		BIT(15)
#define BIT_DCXO_26M_O_REF_OUT2_EXT_XTL3_EN		BIT(14)
#define BIT_DCXO_26M_O_REF_OUT1_EXT_XTL3_EN		BIT(13)
#define BIT_DCXO_26M_O_REF_OUT0_EXT_XTL3_EN		BIT(12)
#define BIT_DCXO_26M_O_REF_OUT3_EXT_XTL2_EN		BIT(11)
#define BIT_DCXO_26M_O_REF_OUT2_EXT_XTL2_EN		BIT(10)
#define BIT_DCXO_26M_O_REF_OUT1_EXT_XTL2_EN		BIT(9)
#define BIT_DCXO_26M_O_REF_OUT0_EXT_XTL2_EN		BIT(8)
#define BIT_DCXO_26M_O_REF_OUT3_EXT_XTL1_EN		BIT(7)
#define BIT_DCXO_26M_O_REF_OUT2_EXT_XTL1_EN		BIT(6)
#define BIT_DCXO_26M_O_REF_OUT1_EXT_XTL1_EN		BIT(5)
#define BIT_DCXO_26M_O_REF_OUT0_EXT_XTL1_EN		BIT(4)
#define BIT_DCXO_26M_O_REF_OUT3_EXT_XTL0_EN		BIT(3)
#define BIT_DCXO_26M_O_REF_OUT2_EXT_XTL0_EN		BIT(2)
#define BIT_DCXO_26M_O_REF_OUT1_EXT_XTL0_EN		BIT(1)
#define BIT_DCXO_26M_O_REF_OUT0_EXT_XTL0_EN		BIT(0)

/* ANA_REG_GLB_TSX_OUT_CTRL1 */

#define BIT_TSX_XO_O_WAKEUP_N				BIT(12)
#define BIT_DCXO_26M_O_REF_OUT3_WAKEUP			BIT(11)
#define BIT_DCXO_26M_O_REF_OUT2_WAKEUP			BIT(10)
#define BIT_DCXO_26M_O_REF_OUT1_WAKEUP			BIT(9)
#define BIT_DCXO_26M_O_REF_OUT0_WAKEUP			BIT(8)
#define BIT_DCXO_26M_O_REF_OUT3_EXT_XTL5_EN		BIT(7)
#define BIT_DCXO_26M_O_REF_OUT2_EXT_XTL5_EN		BIT(6)
#define BIT_DCXO_26M_O_REF_OUT1_EXT_XTL5_EN		BIT(5)
#define BIT_DCXO_26M_O_REF_OUT0_EXT_XTL5_EN		BIT(4)
#define BIT_DCXO_26M_O_REF_OUT3_EXT_XTL4_EN		BIT(3)
#define BIT_DCXO_26M_O_REF_OUT2_EXT_XTL4_EN		BIT(2)
#define BIT_DCXO_26M_O_REF_OUT1_EXT_XTL4_EN		BIT(1)
#define BIT_DCXO_26M_O_REF_OUT0_EXT_XTL4_EN		BIT(0)

/* ANA_REG_GLB_EXT_XTL_TX_CFG */

#define BIT_DEBUG_SEND					BIT(11)
#define BITS_DEBUG_DATA(x)				(((x) & 0x1FF) << 2)
...
#define BIT_BC1P2_DCD_FLAG			BIT(14)
...
#define BITS_CHG_INT_DELAY(x)			(((x) & 0xF) << 8)
#define BIT_DP_DM_AUX_EN			BIT(1)
#define BIT_DP_DM_BC_ENB			BIT(0)

/* ANA_REG_GLB_OVLO_CTRL */

#define BITS_REDET_DELAY(x)			(((x) & 0xF) << 12)
#define BITS_VBAT_CRASH_V(x)			(((x) & 0x3) << 10)
#define BIT_OVLO_EN				BIT(9)
#define BIT_PMIC_PHY_ISO			BIT(7)
#define BIT_BYPASS_APW1_LDO			BIT(6)
#define BITS_UVLO_V(x)				(((x) & 0x3) << 4)
#define BITS_OVLO_V(x)				(((x) & 0x3) << 2)
#define BITS_OVLO_T(x)				(((x) & 0x3))

/* ANA_REG_GLB_MIXED_CTRL */

#define BITS_XOSC32K_CTL(x)			(((x) & 0xR) << 12)
...
#define BITS_SMPL_ENABLE(x)			((x) & 0x1FFF)
...
/* ANA_REG_GLB_SYS_LEVEL_EXCEPTION_CTRL */

#define BIT_VBAT_CRASH_CHIP_PD_FLAG		BIT(7)
#define BIT_OVLO_CHIP_PD_FLAG			BIT(6)
#define BIT_OTP_OUT_WARN_FLAG			BIT(5)
#define BIT_VBAT_CRASH_CHIP_PD_FLAG_CLR		BIT(4)
#define BIT_VBAT_CRASH_EN			BIT(3)
#define BIT_OVLO_CHIP_PD_FLAG_CLR		BIT(2)
#define BIT_OVLO_POWER_OFF_EN			BIT(1)
#define BIT_OTP_OUT_WARN_FLAG_CLR		BIT(0)

/* ANA_REG_GLB_BUCK_TOP_REG0 */

#define BITS_DCDC_MEMQ_IBPFM_TRIM(x)		(((x) & 0x3) << 14)
#define BITS_DCDC_MEM_IBPFM_TRIM(x)		(((x) & 0x3) << 12)
#define BITS_DCDC_CORE_IBPFM_TRIM(x)		(((x) & 0x3) << 10)
#define BITS_DCDC_GEN1_IBPFM_TRIM(x)		(((x) & 0x3) << 8)
#define BITS_DCDC_GEN0_IBPFM_TRIM(x)		(((x) & 0x3) << 6)
#define BITS_DCDC_MODEM_IBPFM_TRIM(x)		(((x) & 0x3) << 4)
#define BITS_DCDC_GPU_IBPFM_TRIM(x)		(((x) & 0x3) << 2)
#define BITS_DCDC_CPU_IBPFM_TRIM(x)		((x) & 0x3)

/* ANA_REG_GLB_BUCK_TOP_REG1 */

#define BITS_DCDC_WPA_RESERVED(x)		(((x) & 0xFF) << 7)
#define BIT_DCDC_MODEM_ANASOFT_EN		BIT(6)
#define BIT_DCDC_GPU_ANASOFT_EN			BIT(5)
#define BIT_DCDC_CPU_ANASOFT_EN			BIT(4)
#define BITS_DCDC_WPA_IBPFM_TRIM(x)		(((x) & 0x3) << 2)
#define BITS_DCDC_SRAM_IBPFM_TRIM(x)		((x) & 0x3)

/* ANA_REG_GLB_BUCK_TOP_REG2 */

#define BIT_DCDC_RTC_RESERVER_SW_SEL		BIT(10)
#define BIT_DCDC_WPA_OS_DET_EN			BIT(9)
#define BITS_DCDC_RTC_RESERVER(x)		((x) & 0x1FF)
...
#define BIT_ACC_IB_TRIM_SEL			BIT(11)
#define BITS_ACC_IB_TRIM(x)			(((x) & 0x7F) << 4)
#define BITS_OTP_WARN(x)			(((x) & 0x3) << 2)
#define BIT_ACC_IB_TEST_EN			BIT(1)
#define BIT_VBG_BUF_SEL				BIT(0)

/* ANA_REG_GLB_PWRON_TOP */

#define BIT_UVLO_BATON_EN			BIT(0)

/* ANA_REG_GLB_DCXO_TSENADC */

#define BIT_DCXO_PD				BIT(0)

/* ANA_REG_GLB_CHG_TOP */

#define BIT_SLAVE_CHG_PD			BIT(2)
#define BITS_VCHG_INT_DET_V(x)			((x) & 0x3)

/* ANA_REG_GLB_BC1P2_G0 */
...
/* ANA_REG_GLB_BC1P2_G1 */

#define BIT_PHYSW_OFF				BIT(1)
#define BIT_BC1P2_REDET				BIT(0)

/* ANA_REG_GLB_FSTCHG_DET */

#define BITS_FSTCHG_LDO_VREF_TRIM(x)		(((x) & 0xF) << 3)
#define BIT_FSTCHG_LDO_BYPASS			BIT(2)
#define BITS_FSTCHG_LDO_V_SEL(x)		((x) & 0x3)

/* ANA_REG_GLB_LDO_VBAT_REG0 */

#define BIT_LDO_VDDSIM2_FAR_CAP_EN		BIT(12)
#define BIT_LDO_VDDSIM1_FAR_CAP_EN		BIT(11)
#define BIT_LDO_VDDSIM0_FAR_CAP_EN		BIT(10)
#define BIT_LDO_VDDCAMMOT_CL_ADJ		BIT(9)
#define BIT_LDO_VDDCAMMOT_FAR_CAP_EN		BIT(8)
#define BIT_LDO_VDDLDO2_CL_ADJ			BIT(7)
#define BIT_LDO_VDDLDO2_FAR_CAP_EN		BIT(6)
#define BIT_LDO_VDDLDO1_FAR_CAP_EN		BIT(5)
#define BIT_LDO_VDDUSB33_FAR_CAP_EN		BIT(4)
#define BIT_LDO_VDD28_CL_ADJ			BIT(3)
#define BIT_LDO_VDD28_FAR_CAP_EN		BIT(2)
#define BIT_LDO_VDDSDIO_CL_ADJ			BIT(1)
#define BIT_LDO_VDDSDIO_FAR_CAP_EN		BIT(0)

/* ANA_REG_GLB_LDO_VBAT_REG1 */

#define BIT_LDO_VDDLDO3_FAR_CAP_EN		BIT(15)
#define BITS_LDO_VDDLDO3_REFTRIM(x)		(((x) & 0x1F) << 10)
#define BITS_LDO_VDDLDO3_V(x)			(((x) & 0xFF) << 2)
#define BIT_LDO_VDDLDO3_SHPT_PD			BIT(1)
#define BIT_LDO_VDDLDO3_PD			BIT(0)

/* ANA_REG_GLB_LDO_VBAT_REG2 */

#define BITS_LDO_VDDCAMA1_SSTART_OPT(x)		(((x) & 0x7) << 13)
#define BIT_LDO_VDDCAMA1_CL_ADJ			BIT(12)
#define BIT_LDO_VDDCAMA0_CL_ADJ			BIT(11)
#define BITS_LDO_VDDCAMA0_SSTART_OPT(x)		(((x) & 0x7) << 8)
#define BIT_LDO_VDDSDCORE_FAR_CAP_EN		BIT(7)
#define BIT_LDO_VDDEMMCCORE_FAR_CAP_EN		BIT(6)
#define BITS_LDO_VDDEMMCCORE_CL_ADJ(x)		(((x) & 0xF) << 2)
#define BIT_LDO_VDDLDO0_FAR_CAP_EN		BIT(1)
#define BIT_LDO_VDDWIFIPA_FAR_CAP_EN		BIT(0)

/* ANA_REG_GLB_LDO_VBAT_REG3 */

#define BITS_LDO_VDDWIFIPA_CL_ADJ(x)		((x) & 0xFF)

/* ANA_REG_GLB_LDO_RTC_CTRL1 */

#define BIT_RC32K_CAL_SW_SEL			BIT(7)
#define BITS_RC32K_CAL(x)			((x) & 0x7F)

/* ANA_REG_GLB_LDO_DCDC */

#define BIT_LDO_VDDCAMD1_RMCAP_EN		BIT(15)
#define BIT_LDO_VDDCAMD0_RMCAP_EN		BIT(14)
#define BIT_LDO_VDDCAMD1_GM_SEL			BIT(13)
#define BIT_LDO_VDDCAMD0_GM_SEL			BIT(12)
#define BITS_LDO_AVDD12_CL_ADJ(x)		(((x) & 0xF) << 8)
#define BITS_LDO_VDDCAMD1_CL_ADJ(x)		(((x) & 0xF) << 4)
#define BITS_LDO_VDDCAMD0_CL_ADJ(x)		((x) & 0xF)

/* ANA_REG_GLB_TYPEC_DET_CURRENT_OFFSET */

#define BIT_RG_TYPEC_DET_CURRENT_OFFSET		BIT(0)

/* ANA_REG_GLB_LDO_XTL_EN13 */

#define BIT_LDO_VDDLDO3_EXT_XTL0_EN		BIT(5)
#define BIT_LDO_VDDLDO3_EXT_XTL1_EN		BIT(4)
#define BIT_LDO_VDDLDO3_EXT_XTL2_EN		BIT(3)
#define BIT_LDO_VDDLDO3_EXT_XTL3_EN		BIT(2)
#define BIT_LDO_VDDLDO3_EXT_XTL4_EN		BIT(1)
#define BIT_LDO_VDDLDO3_EXT_XTL5_EN		BIT(0)

/* ANA_REG_GLB_AUD_CLK_CTRL */

#define BIT_AUD_48K_DIV_MODE			BIT(1)
#define BIT_AUD_48K_DIV_EN			BIT(0)

/* ANA_REG_GLB_BUCK_TOP_REG3 */

#define BIT_DCDC_WPA_IBPFM_TRIM_SW_SEL		BIT(15)
#define BIT_DCDC_SRAM_IBPFM_TRIM_SW_SEL		BIT(14)
#define BIT_DCDC_MEMQ_IBPFM_TRIM_SW_SEL		BIT(13)
#define BIT_DCDC_MEM_IBPFM_TRIM_SW_SEL		BIT(12)
#define BIT_DCDC_CORE_IBPFM_TRIM_SW_SEL		BIT(11)
#define BIT_DCDC_GEN1_IBPFM_TRIM_SW_SEL		BIT(10)
#define BIT_DCDC_GEN0_IBPFM_TRIM_SW_SEL		BIT(9)
#define BIT_DCDC_MODEM_IBPFM_TRIM_SW_SEL	BIT(8)
#define BIT_DCDC_CPU_IBPFM_TRIM_SW_SEL		BIT(7)
#define BIT_DCDC_GPU_IBPFM_TRIM_SW_SEL		BIT(6)
#define BIT_LDO_VDDLDO3_SW_SEL			BIT(5)
#define BIT_LDO_VDDEMMCCORE_CL_ADJ_SW_SEL	BIT(4)
#define BIT_LDO_VDDWIFIPA_CL_ADJ_SW_SEL		BIT(3)
#define BIT_LDO_AVDD12_CL_ADJ_SW_SEL		BIT(2)
#define BIT_LDO_VDDCAMD0_CL_ADJ_SW_SEL		BIT(1)
#define BIT_LDO_VDDCAMD1_CL_ADJ_SW_SEL		BIT(0)

/* ANA_REG_GLB_RTC_ALL_TOP */

#define BITS_RC32K_TC_CAL(x)			((x) & 0x7)

/* ANA_REG_GLB_CURRENT_DRV_TOP */

#define BIT_LDO_VDDVIB_CL_ADJ_SW_SEL		BIT(4)
#define BITS_LDO_VDDVIB_CL_ADJ(x)		((x) & 0xF)
