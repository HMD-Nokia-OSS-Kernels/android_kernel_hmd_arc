/*
*  sprd_752x.h  - 7520 pmic pinmap config
*
*  Copyright (C) 2019 Unisoc Communications Inc.
*  History:
*      2020-08-17 linhua.xu@unisoc.com
*      Add 7520 pinmap configuration
*/

#ifndef _SPRD_752x_H_
#define _SPRD_752x_H_


#include "adi.h"
#include <asm/arch/sprd_reg.h>

/* here is the pinmap info of adie such as 7520 */
#define CTL_ANA_PIN_BASE			(ANA_PIN_BASE)

/* registers definitions for controller CTL_PIN */
#define REG_PIN_ANA_PTESTO			( 0x0c )
