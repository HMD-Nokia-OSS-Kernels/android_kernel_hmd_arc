...
#define REG_AP_CLK_CGM_IPA_AXI_SEL_CFG                                      SCI_ADDR(CTL_AP_CLK_BASE, 0x016C)
#define REG_AP_CLK_CGM_IPA_APB_DIV_CFG                                      SCI_ADDR(CTL_AP_CLK_BASE, 0x0174)
#define REG_AP_CLK_CGM_BUSY_SRC_MONITOR_CFG0                                SCI_ADDR(CTL_AP_CLK_BASE, 0x0188)
#define REG_AP_CLK_CGM_BUSY_SRC_MONITOR_CFG1                                SCI_ADDR(CTL_AP_CLK_BASE, 0x018C)
#define REG_AP_CLK_CGM_BUSY_SRC_MONITOR_CFG2                                SCI_ADDR(CTL_AP_CLK_BASE, 0x0190)
#define REG_AP_CLK_CGM_BUSY_SRC_MONITOR_CFG3                                SCI_ADDR(CTL_AP_CLK_BASE, 0x0194)
...
/* bits definitions for REG_AP_CLK_CGM_IPA_AXI_SEL_CFG, [0x2001016C] */
#define BIT_AP_CLK_CGM_IPA_AXI_SEL_DFS(x)       ((x) << 8  & (BIT(8) | BIT(9)))
#define BIT_AP_CLK_CGM_IPA_AXI_SEL(x)           ((x) << 0  & (BIT(0) | BIT(1)))

/* bits definitions for REG_AP_CLK_CGM_IPA_APB_DIV_CFG, [0x20010174] */
#define BIT_AP_CLK_CGM_IPA_APB_DIV(x)           ((x) << 0  & (BIT(0) | BIT(1)))

/* bits definitions for REG_AP_CLK_CGM_BUSY_SRC_MONITOR_CFG0, [0x20010188] */
#define BIT_AP_CLK_CGM_BUSY_SRC_MONITOR0(x)     ((x))

/* bits definitions for REG_AP_CLK_CGM_BUSY_SRC_MONITOR_CFG1, [0x2001018C] */
#define BIT_AP_CLK_CGM_BUSY_SRC_MONITOR1(x)     ((x))

/* bits definitions for REG_AP_CLK_CGM_BUSY_SRC_MONITOR_CFG2, [0x20010190] */
#define BIT_AP_CLK_CGM_BUSY_SRC_MONITOR2(x)     ((x))

/* bits definitions for REG_AP_CLK_CGM_BUSY_SRC_MONITOR_CFG3, [0x20010194] */
#define BIT_AP_CLK_CGM_BUSY_SRC_MONITOR3(x)     ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6) | BIT(7) | BIT(8) | BIT(9) | BIT(10) | BIT(11) | BIT(12) | BIT(13) | BIT(14) | BIT(15) | BIT(16) | BIT(17) | BIT(18) | BIT(19)))
