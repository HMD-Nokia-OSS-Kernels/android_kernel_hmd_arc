...
#define REG_PUB_APB_OTHER_AXI_BUSY_EN_0                                      SCI_ADDR(CTL_PUB_APB_BASE, 0x6814)
#define REG_PUB_APB_OTHER_AXI_BUSY_EN_1                                      SCI_ADDR(CTL_PUB_APB_BASE, 0x6818)
...
/* bits definitions for REG_PUB_APB_OTHER_AXI_BUSY_EN_0, [0x60056814] */
#define BIT_PUB_APB_OTHER_AXI_BUSY_EN_0(x)                          ((x))

/* bits definitions for REG_PUB_APB_OTHER_AXI_BUSY_EN_1, [0x60056818] */
#define BIT_PUB_APB_OTHER_AXI_BUSY_EN_1(x)                          ((x))
