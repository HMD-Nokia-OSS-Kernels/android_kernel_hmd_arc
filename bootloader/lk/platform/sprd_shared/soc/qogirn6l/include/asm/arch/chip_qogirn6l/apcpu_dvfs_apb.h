...
#define REG_APCPU_DVFS_APB_APCPU_DCDC_SRAM3_MIN_VOL                            SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0430)
#define REG_APCPU_DVFS_APB_APCPU_DCDC_SRAM3_SW_DVFS_CTRL                       SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0434)
#define REG_APCPU_DVFS_APB_APCPU_SRAM3_DVFS_STATE_DBG                          SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0438)
#define REG_APCPU_DVFS_APB_SCU_VOTE_SRAM1_VOL_CFG0                             SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x043C)
#define REG_APCPU_DVFS_APB_SCU_VOTE_SRAM1_VOL_CFG1                             SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0440)
#define REG_APCPU_DVFS_APB_GIC_VOTE_SRAM1_VOL_CFG0                             SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0444)
#define REG_APCPU_DVFS_APB_GIC_VOTE_SRAM1_VOL_CFG1                             SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0448)
#define REG_APCPU_DVFS_APB_ATB_VOTE_SRAM1_VOL_CFG0                             SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x044C)
#define REG_APCPU_DVFS_APB_ATB_VOTE_SRAM1_VOL_CFG1                             SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0450)
#define REG_APCPU_DVFS_APB_APCPU0_TWO_STEP_SCALE                               SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0454)
#define REG_APCPU_DVFS_APB_APCPU1_TWO_STEP_SCALE                               SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0458)
#define REG_APCPU_DVFS_APB_APCPU2_TWO_STEP_SCALE                               SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x045C)
#define REG_APCPU_DVFS_APB_DVFS_HISTORY1_DEBUG_M                               SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0460)
#define REG_APCPU_DVFS_APB_DVFS_HISTORY1_DEBUG_L                               SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0464)
#define REG_APCPU_DVFS_APB_DVFS_HISTORY2_DEBUG_M                               SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0468)
#define REG_APCPU_DVFS_APB_DVFS_HISTORY2_DEBUG_L                               SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x046C)
#define REG_APCPU_DVFS_APB_DVFS_HISTORY3_DEBUG_M                               SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0470)
#define REG_APCPU_DVFS_APB_DVFS_HISTORY3_DEBUG_L                               SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0474)
#define REG_APCPU_DVFS_APB_DVFS_HISTORY4_DEBUG_M                               SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0478)
#define REG_APCPU_DVFS_APB_DVFS_HISTORY4_DEBUG_L                               SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x047C)
#define REG_APCPU_DVFS_APB_DVFS_HISTORY5_DEBUG_M                               SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0480)
#define REG_APCPU_DVFS_APB_DVFS_HISTORY5_DEBUG_L                               SCI_ADDR(CTL_APCPU_DVFS_APB_BASE, 0x0484)
...
#define BIT_APCPU_DVFS_APB_CGM_APCPU_DEBUG_APB_DIV_DVFS(x)            ((x) << 24 & (BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_CGM_APCPU_ATB_DIV_DVFS(x)                  ((x) << 21 & (BIT(21) | BIT(22) | BIT(23)))
#define BIT_APCPU_DVFS_APB_CGM_APCPU_ATB_SEL_DVFS(x)                  ((x) << 19 & (BIT(19) | BIT(20)))
#define BIT_APCPU_DVFS_APB_CGM_APCPU_PERIPH_DIV_DVFS(x)               ((x) << 16 & (BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_CGM_APCPU_PERIPH_SEL_DVFS(x)               ((x) << 14 & (BIT(14) | BIT(15)))
#define BIT_APCPU_DVFS_APB_CGM_APCPU_ACE_DIV_DVFS                     BIT(13)
#define BIT_APCPU_DVFS_APB_CGM_APCPU_SCU_DIV_DVFS                     BIT(12)
#define BIT_APCPU_DVFS_APB_CGM_APCPU_SCU_SEL_DVFS(x)                  ((x) << 9  & (BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_CGM_APCPU_CORE7_DIV_DVFS                   BIT(7)
#define BIT_APCPU_DVFS_APB_CGM_APCPU_CORE7_SEL_DVFS(x)                ((x) << 4  & (BIT(4) | BIT(5) | BIT(6)))
...
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU0_DVFS_WINDOW_CNT(x)         ((x) << 12 & (BIT(12) | BIT(13) | BIT(14) | BIT(15) | BIT(16) | BIT(17) | BIT(18) | BIT(19) | BIT(20) | BIT(21) | BIT(22) | BIT(23) | BIT(24) | BIT(25) | BIT(26) | BIT(27)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU0_CURRENT_VOLTAGE(x)         ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU0_VOTE_VOL(x)                ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU0_DVFS_STATE(x)              ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))

/* bits definitions for REG_APCPU_DVFS_APB_APCPU_CPU1_DVFS_STATE_DBG, [0x6495004C] */
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU1_DVFS_WINDOW_CNT(x)         ((x) << 12 & (BIT(12) | BIT(13) | BIT(14) | BIT(15) | BIT(16) | BIT(17) | BIT(18) | BIT(19) | BIT(20) | BIT(21) | BIT(22) | BIT(23) | BIT(24) | BIT(25) | BIT(26) | BIT(27)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU1_CURRENT_VOLTAGE(x)         ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU1_VOTE_VOL(x)                ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU1_DVFS_STATE(x)              ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))

/* bits definitions for REG_APCPU_DVFS_APB_APCPU_CPU2_DVFS_STATE_DBG, [0x64950050] */
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU2_DVFS_WINDOW_CNT(x)         ((x) << 12 & (BIT(12) | BIT(13) | BIT(14) | BIT(15) | BIT(16) | BIT(17) | BIT(18) | BIT(19) | BIT(20) | BIT(21) | BIT(22) | BIT(23) | BIT(24) | BIT(25) | BIT(26) | BIT(27)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU2_CURRENT_VOLTAGE(x)         ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU2_VOTE_VOL(x)                ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU2_DVFS_STATE(x)              ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))

/* bits definitions for REG_APCPU_DVFS_APB_ANANKE_DVFS_INDEX0_0, [0x64950060] */
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX0(x)                  ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX0(x)                       ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX0(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX1(x)                  ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX1(x)                       ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX1(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX2(x)                  ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX2(x)                       ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX2(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX3(x)                  ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX3(x)                       ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX3(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX4(x)                  ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX4(x)                       ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX4(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX5(x)                  ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX5(x)                       ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX5(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX6(x)                  ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX6(x)                       ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX6(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX7(x)                  ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX7(x)                       ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX7(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX8(x)                  ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX8(x)                       ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX8(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX9(x)                  ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX9(x)                       ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX9(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX10(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX10(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX10(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX11(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX11(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX11(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX12(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX12(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX12(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX13(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX13(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX13(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX14(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX14(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX14(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_ANANKE_VOTE_GIC_INDEX15(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ANANKE_VOL_INDEX15(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_INDEX15(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX0(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX0(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX0(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX0(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX1(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX1(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX1(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX1(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX2(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX2(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX2(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX2(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX3(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX3(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX3(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX3(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX4(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX4(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX4(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX4(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX5(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX5(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX5(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX5(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX6(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX6(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX6(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX6(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX7(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX7(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX7(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX7(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX8(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX8(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX8(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX8(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX9(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX9(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX9(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX9(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX10(x)                       ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX10(x)                ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX10(x)                     ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX10(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX11(x)                       ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX11(x)                ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX11(x)                     ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX11(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX12(x)                       ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX12(x)                ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX12(x)                     ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX12(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX13(x)                       ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX13(x)                ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX13(x)                     ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX13(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX14(x)                       ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX14(x)                ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX14(x)                     ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX14(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM2_VOL_INDEX15(x)                       ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOTE_GIC_INDEX15(x)                ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOMID_VOL_INDEX15(x)                     ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_INDEX15(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
...
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX0(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX0(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX0(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX0(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX0(x)              ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX0(x)                 ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX0                     BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX0(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX1_0, [0x649500E4] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX1(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX1(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX1(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX1(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX1(x)              ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX1(x)                 ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX1                     BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX1(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX2_0, [0x649500E8] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX2(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX2(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX2(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX2(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX2(x)              ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX2(x)                 ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX2                     BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX2(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX3_0, [0x649500EC] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX3(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX3(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX3(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX3(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX3(x)              ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX3(x)                 ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX3                     BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX3(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX4_0, [0x649500F0] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX4(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX4(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX4(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX4(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX4(x)              ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX4(x)                 ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX4                     BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX4(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX5_0, [0x649500F4] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX5(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX5(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX5(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX5(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX5(x)              ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX5(x)                 ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX5                     BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX5(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX6_0, [0x649500F8] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX6(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX6(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX6(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX6(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX6(x)              ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX6(x)                 ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX6                     BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX6(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX7_0, [0x649500FC] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX7(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX7(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX7(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX7(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX7(x)              ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX7(x)                 ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX7                     BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX7(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX8, [0x64950100] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX8(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX8(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX8(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX8(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX8(x)              ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX8(x)                 ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX8                     BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX8(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX9, [0x64950104] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX9(x)                        ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX9(x)                 ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX9(x)                      ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX9(x)                    ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX9(x)              ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX9(x)                 ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX9                     BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX9(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX10, [0x64950108] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX10(x)                       ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX10(x)                ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX10(x)                     ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX10(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX10(x)             ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX10(x)                ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX10                    BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX10(x)                 ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX11, [0x6495010C] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX11(x)                       ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX11(x)                ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX11(x)                     ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX11(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX11(x)             ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX11(x)                ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX11                    BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX11(x)                 ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX12, [0x64950110] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX12(x)                       ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX12(x)                ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX12(x)                     ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX12(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX12(x)             ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX12(x)                ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX12                    BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX12(x)                 ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX13, [0x64950114] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX13(x)                       ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX13(x)                ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX13(x)                     ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX13(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX13(x)             ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX13(x)                ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX13                    BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX13(x)                 ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX14, [0x64950118] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX14(x)                       ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX14(x)                ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX14(x)                     ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX14(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX14(x)             ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX14(x)                ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX14                    BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX14(x)                 ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_ENYOBIG_DVFS_INDEX15, [0x6495011C] */
#define BIT_APCPU_DVFS_APB_SRAM3_VOL_INDEX15(x)                       ((x) << 22 & (BIT(22) | BIT(23) | BIT(24) | BIT(25)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_GIC_INDEX15(x)                ((x) << 19 & (BIT(19) | BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOL_INDEX15(x)                     ((x) << 15 & (BIT(15) | BIT(16) | BIT(17) | BIT(18)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_INDEX15(x)                   ((x) << 11 & (BIT(11) | BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_PERIPH_INDEX15(x)             ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_ENYOBIG_VOTE_SCU_INDEX15(x)                ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_DIV_INDEX15                    BIT(3)
#define BIT_APCPU_DVFS_APB_CGM_ENYOBIG_SEL_INDEX15(x)                 ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_APCPU_SCU_DVFS_INDEX0, [0x64950120] */
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX0(x)                    ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX0(x)                    ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX1(x)                    ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX1(x)                    ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX2(x)                    ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX2(x)                    ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX3(x)                    ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX3(x)                    ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX4(x)                    ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX4(x)                    ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX5(x)                    ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX5(x)                    ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX6(x)                    ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX6(x)                    ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX7(x)                    ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX7(x)                    ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX8(x)                    ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX8(x)                    ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX9(x)                    ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX9(x)                    ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX10(x)                   ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX10(x)                   ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX11(x)                   ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX11(x)                   ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX12(x)                   ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX12(x)                   ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX13(x)                   ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX13(x)                   ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX14(x)                   ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX14(x)                   ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOL_INDEX15(x)                   ((x) << 9  & (BIT(9) | BIT(10) | BIT(11) | BIT(12)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_INDEX15(x)                   ((x) << 5  & (BIT(5) | BIT(6) | BIT(7) | BIT(8)))
...
#define BIT_APCPU_DVFS_APB_APCPU_SRAM1_DVFS_INDEX(x)                  ((x) << 3  & (BIT(3) | BIT(4) | BIT(5) | BIT(6)))
...
#define BIT_APCPU_DVFS_APB_MPLL_SCU_CNT_DONE                          BIT(27)
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_CLKOUT_EN                    BIT(26)
#define BIT_APCPU_DVFS_APB_MPLL_SCU_DVFS_PD                           BIT(25)
#define BIT_APCPU_DVFS_APB_MPLL_SCU_INDEX(x)                          ((x) << 21 & (BIT(21) | BIT(22) | BIT(23) | BIT(24)))
#define BIT_APCPU_DVFS_APB_MPLL_BIG_CNT_DONE                          BIT(20)
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_CLKOUT_EN                    BIT(19)
#define BIT_APCPU_DVFS_APB_MPLL_BIG_DVFS_PD                           BIT(18)
#define BIT_APCPU_DVFS_APB_MPLL_BIG_INDEX(x)                          ((x) << 14 & (BIT(14) | BIT(15) | BIT(16) | BIT(17)))
#define BIT_APCPU_DVFS_APB_MPLL_MID_CNT_DONE                          BIT(13)
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_CLKOUT_EN                    BIT(12)
#define BIT_APCPU_DVFS_APB_MPLL_MID_DVFS_PD                           BIT(11)
#define BIT_APCPU_DVFS_APB_MPLL_MID_INDEX(x)                          ((x) << 7  & (BIT(7) | BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_MPLL_LIT_CNT_DONE                          BIT(6)
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_CLKOUT_EN                    BIT(5)
#define BIT_APCPU_DVFS_APB_MPLL_LIT_DVFS_PD                           BIT(4)
#define BIT_APCPU_DVFS_APB_MPLL_LIT_INDEX(x)                          ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))
...
#define BIT_APCPU_DVFS_APB_CGM_APCPU_ACE_DIV_RELOCK_BYP               BIT(12)
#define BIT_APCPU_DVFS_APB_CGM_APCPU_SCU_DIV_RELOCK_BYP               BIT(11)
#define BIT_APCPU_DVFS_APB_CGM_APCPU_SCU_SEL_RELOCK_BYP(x)            ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_APCPU_DVFS_APB_CGM_APCPU_CORE7_DIV_RELOCK_BYP             BIT(7)
#define BIT_APCPU_DVFS_APB_CGM_APCPU_CORE7_SEL_RELOCK_BYP(x)          ((x) << 4  & (BIT(4) | BIT(5) | BIT(6)))
...
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM2_DVFS_WINDOW_CNT(x)        ((x) << 12 & (BIT(12) | BIT(13) | BIT(14) | BIT(15) | BIT(16) | BIT(17) | BIT(18) | BIT(19) | BIT(20) | BIT(21) | BIT(22) | BIT(23) | BIT(24) | BIT(25) | BIT(26) | BIT(27)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM2_CURRENT_VOLTAGE(x)        ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM2_VOTE_VOL(x)               ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM2_DVFS_STATE(x)             ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))
...
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM3_VOL_DOWN_EARLY_UPD_EN     BIT(5)
...
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM1_DVFS_WINDOW_CNT(x)        ((x) << 12 & (BIT(12) | BIT(13) | BIT(14) | BIT(15) | BIT(16) | BIT(17) | BIT(18) | BIT(19) | BIT(20) | BIT(21) | BIT(22) | BIT(23) | BIT(24) | BIT(25) | BIT(26) | BIT(27)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM1_CURRENT_VOLTAGE(x)        ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM1_VOTE_VOL(x)               ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM1_DVFS_STATE(x)             ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))

/* bits definitions for REG_APCPU_DVFS_APB_APCPU_SRAM1_VOL_CFG0, [0x64950424] */
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX7(x)                        ((x) << 28 & (BIT(28) | BIT(29) | BIT(30) | BIT(31)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX6(x)                        ((x) << 24 & (BIT(24) | BIT(25) | BIT(26) | BIT(27)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX5(x)                        ((x) << 20 & (BIT(20) | BIT(21) | BIT(22) | BIT(23)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX4(x)                        ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX3(x)                        ((x) << 12 & (BIT(12) | BIT(13) | BIT(14) | BIT(15)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX2(x)                        ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX1(x)                        ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX0(x)                        ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))

/* bits definitions for REG_APCPU_DVFS_APB_APCPU_SRAM1_VOL_CFG1, [0x64950428] */
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX15(x)                       ((x) << 28 & (BIT(28) | BIT(29) | BIT(30) | BIT(31)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX14(x)                       ((x) << 24 & (BIT(24) | BIT(25) | BIT(26) | BIT(27)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX13(x)                       ((x) << 20 & (BIT(20) | BIT(21) | BIT(22) | BIT(23)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX12(x)                       ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX11(x)                       ((x) << 12 & (BIT(12) | BIT(13) | BIT(14) | BIT(15)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX10(x)                       ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX9(x)                        ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_SRAM1_VOL_INDEX8(x)                        ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))

/* bits definitions for REG_APCPU_DVFS_APB_APCPU_FREQ_UPD_SRAM_VOL_EN_CFG, [0x6495042C] */
#define BIT_APCPU_DVFS_APB_CORE7_VOL_DCDC_SRAM3_EN                    BIT(12)
#define BIT_APCPU_DVFS_APB_CORE6_VOL_DCDC_SRAM2_EN                    BIT(11)
#define BIT_APCPU_DVFS_APB_CORE5_VOL_DCDC_SRAM1_EN                    BIT(10)
#define BIT_APCPU_DVFS_APB_CORE4_VOL_DCDC_SRAM1_EN                    BIT(9)
...
/* bits definitions for REG_APCPU_DVFS_APB_APCPU_DCDC_SRAM3_MIN_VOL, [0x64950430] */
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM3_MIN_VOL(x)                ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))

/* bits definitions for REG_APCPU_DVFS_APB_APCPU_DCDC_SRAM3_SW_DVFS_CTRL, [0x64950434] */
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM3_DVFS_ACK                  BIT(12)
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM3_DVFS_VOLTAGE_SW(x)        ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM3_DVFS_REQ_SW               BIT(0)

/* bits definitions for REG_APCPU_DVFS_APB_APCPU_SRAM3_DVFS_STATE_DBG, [0x64950438] */
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM3_DVFS_WINDOW_CNT(x)        ((x) << 12 & (BIT(12) | BIT(13) | BIT(14) | BIT(15) | BIT(16) | BIT(17) | BIT(18) | BIT(19) | BIT(20) | BIT(21) | BIT(22) | BIT(23) | BIT(24) | BIT(25) | BIT(26) | BIT(27)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM3_CURRENT_VOLTAGE(x)        ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM3_VOTE_VOL(x)               ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_SRAM3_DVFS_STATE(x)             ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))

/* bits definitions for REG_APCPU_DVFS_APB_SCU_VOTE_SRAM1_VOL_CFG0, [0x6495043C] */
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX7(x)         ((x) << 28 & (BIT(28) | BIT(29) | BIT(30) | BIT(31)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX6(x)         ((x) << 24 & (BIT(24) | BIT(25) | BIT(26) | BIT(27)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX5(x)         ((x) << 20 & (BIT(20) | BIT(21) | BIT(22) | BIT(23)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX4(x)         ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX3(x)         ((x) << 12 & (BIT(12) | BIT(13) | BIT(14) | BIT(15)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX2(x)         ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX1(x)         ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX0(x)         ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))

/* bits definitions for REG_APCPU_DVFS_APB_SCU_VOTE_SRAM1_VOL_CFG1, [0x64950440] */
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX15(x)        ((x) << 28 & (BIT(28) | BIT(29) | BIT(30) | BIT(31)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX14(x)        ((x) << 24 & (BIT(24) | BIT(25) | BIT(26) | BIT(27)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX13(x)        ((x) << 20 & (BIT(20) | BIT(21) | BIT(22) | BIT(23)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX12(x)        ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX11(x)        ((x) << 12 & (BIT(12) | BIT(13) | BIT(14) | BIT(15)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX10(x)        ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX9(x)         ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_APCPU_SCU_VOTE_SRAM1_VOL_INDEX8(x)         ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))

/* bits definitions for REG_APCPU_DVFS_APB_GIC_VOTE_SRAM1_VOL_CFG0, [0x64950444] */
#define BIT_APCPU_DVFS_APB_APCPU_GIC_VOTE_SRAM1_VOL_INDEX7(x)         ((x) << 28 & (BIT(28) | BIT(29) | BIT(30) | BIT(31)))
#define BIT_APCPU_DVFS_APB_APCPU_GIC_VOTE_SRAM1_VOL_INDEX6(x)         ((x) << 24 & (BIT(24) | BIT(25) | BIT(26) | BIT(27)))
#define BIT_APCPU_DVFS_APB_APCPU_GIC_VOTE_SRAM1_VOL_INDEX5(x)         ((x) << 20 & (BIT(20) | BIT(21) | BIT(22) | BIT(23)))
#define BIT_APCPU_DVFS_APB_APCPU_GIC_VOTE_SRAM1_VOL_INDEX4(x)         ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_APCPU_GIC_VOTE_SRAM1_VOL_INDEX3(x)         ((x) << 12 & (BIT(12) | BIT(13) | BIT(14) | BIT(15)))
#define BIT_APCPU_DVFS_APB_APCPU_GIC_VOTE_SRAM1_VOL_INDEX2(x)         ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_APCPU_GIC_VOTE_SRAM1_VOL_INDEX1(x)         ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_APCPU_GIC_VOTE_SRAM1_VOL_INDEX0(x)         ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))

/* bits definitions for REG_APCPU_DVFS_APB_GIC_VOTE_SRAM1_VOL_CFG1, [0x64950448] */

/* bits definitions for REG_APCPU_DVFS_APB_ATB_VOTE_SRAM1_VOL_CFG0, [0x6495044C] */
#define BIT_APCPU_DVFS_APB_APCPU_ATB_VOTE_SRAM1_VOL_INDEX7(x)         ((x) << 28 & (BIT(28) | BIT(29) | BIT(30) | BIT(31)))
#define BIT_APCPU_DVFS_APB_APCPU_ATB_VOTE_SRAM1_VOL_INDEX6(x)         ((x) << 24 & (BIT(24) | BIT(25) | BIT(26) | BIT(27)))
#define BIT_APCPU_DVFS_APB_APCPU_ATB_VOTE_SRAM1_VOL_INDEX5(x)         ((x) << 20 & (BIT(20) | BIT(21) | BIT(22) | BIT(23)))
#define BIT_APCPU_DVFS_APB_APCPU_ATB_VOTE_SRAM1_VOL_INDEX4(x)         ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_APCPU_ATB_VOTE_SRAM1_VOL_INDEX3(x)         ((x) << 12 & (BIT(12) | BIT(13) | BIT(14) | BIT(15)))
#define BIT_APCPU_DVFS_APB_APCPU_ATB_VOTE_SRAM1_VOL_INDEX2(x)         ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_APCPU_ATB_VOTE_SRAM1_VOL_INDEX1(x)         ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_APCPU_ATB_VOTE_SRAM1_VOL_INDEX0(x)         ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3)))

/* bits definitions for REG_APCPU_DVFS_APB_ATB_VOTE_SRAM1_VOL_CFG1, [0x64950450] */

/* bits definitions for REG_APCPU_DVFS_APB_APCPU0_TWO_STEP_SCALE, [0x64950454] */
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU0_LIMIT_VOL(x)               ((x) << 1  & (BIT(1) | BIT(2) | BIT(3) | BIT(4)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU0_STEP_VOLTAGE_TUNE_EN       BIT(0)

/* bits definitions for REG_APCPU_DVFS_APB_APCPU1_TWO_STEP_SCALE, [0x64950458] */
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU1_LIMIT_VOL(x)               ((x) << 1  & (BIT(1) | BIT(2) | BIT(3) | BIT(4)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU1_STEP_VOLTAGE_TUNE_EN       BIT(0)

/* bits definitions for REG_APCPU_DVFS_APB_APCPU2_TWO_STEP_SCALE, [0x6495045C] */
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU2_LIMIT_VOL(x)               ((x) << 1  & (BIT(1) | BIT(2) | BIT(3) | BIT(4)))
#define BIT_APCPU_DVFS_APB_APCPU_DCDC_CPU2_STEP_VOLTAGE_TUNE_EN       BIT(0)

/* bits definitions for REG_APCPU_DVFS_APB_DVFS_HISTORY1_DEBUG_M, [0x64950460] */
#define BIT_APCPU_DVFS_APB_MPLL_CPU1_INDEX_HISTORY1(x)                ((x) << 20 & (BIT(20) | BIT(21) | BIT(22) | BIT(23)))
#define BIT_APCPU_DVFS_APB_CPU1_VOLTAGE_DVFS_HISTORY1(x)              ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_CPU1_DIV_DVFS_HISTORY1                     BIT(15)
#define BIT_APCPU_DVFS_APB_CPU1_SEL_DVFS_HISTORY1(x)                  ((x) << 12 & (BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_MPLL_CPU0_INDEX_HISTORY1(x)                ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_CPU0_VOLTAGE_DVFS_HISTORY1(x)              ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CPU0_DIV_DVFS_HISTORY1                     BIT(3)
#define BIT_APCPU_DVFS_APB_CPU0_SEL_DVFS_HISTORY1(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_DVFS_HISTORY1_DEBUG_L, [0x64950464] */
#define BIT_APCPU_DVFS_APB_GIC_DIV_DVFS_HISTORY1(x)                   ((x) << 27 & (BIT(27) | BIT(28) | BIT(29)))
#define BIT_APCPU_DVFS_APB_GIC_SEL_DVFS_HISTORY1(x)                   ((x) << 25 & (BIT(25) | BIT(26)))
#define BIT_APCPU_DVFS_APB_PERIPH_DIV_DVFS_HISTORY1(x)                ((x) << 22 & (BIT(22) | BIT(23) | BIT(24)))
#define BIT_APCPU_DVFS_APB_PERIPH_SEL_DVFS_HISTORY1(x)                ((x) << 20 & (BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_INDEX_HISTORY1(x)                 ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_SCU_DIV_DVFS_HISTORY1                      BIT(15)
#define BIT_APCPU_DVFS_APB_SCU_SEL_DVFS_HISTORY1(x)                   ((x) << 12 & (BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_MPLL_CPU2_INDEX_HISTORY1(x)                ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_CPU2_VOLTAGE_DVFS_HISTORY1(x)              ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CPU2_DIV_DVFS_HISTORY1                     BIT(3)
#define BIT_APCPU_DVFS_APB_CPU2_SEL_DVFS_HISTORY1(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_DVFS_HISTORY2_DEBUG_M, [0x64950468] */
#define BIT_APCPU_DVFS_APB_MPLL_CPU1_INDEX_HISTORY2(x)                ((x) << 20 & (BIT(20) | BIT(21) | BIT(22) | BIT(23)))
#define BIT_APCPU_DVFS_APB_CPU1_VOLTAGE_DVFS_HISTORY2(x)              ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_CPU1_DIV_DVFS_HISTORY2                     BIT(15)
#define BIT_APCPU_DVFS_APB_CPU1_SEL_DVFS_HISTORY2(x)                  ((x) << 12 & (BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_MPLL_CPU0_INDEX_HISTORY2(x)                ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_CPU0_VOLTAGE_DVFS_HISTORY2(x)              ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CPU0_DIV_DVFS_HISTORY2                     BIT(3)
#define BIT_APCPU_DVFS_APB_CPU0_SEL_DVFS_HISTORY2(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_DVFS_HISTORY2_DEBUG_L, [0x6495046C] */
#define BIT_APCPU_DVFS_APB_GIC_DIV_DVFS_HISTORY2(x)                   ((x) << 27 & (BIT(27) | BIT(28) | BIT(29)))
#define BIT_APCPU_DVFS_APB_GIC_SEL_DVFS_HISTORY2(x)                   ((x) << 25 & (BIT(25) | BIT(26)))
#define BIT_APCPU_DVFS_APB_PERIPH_DIV_DVFS_HISTORY2(x)                ((x) << 22 & (BIT(22) | BIT(23) | BIT(24)))
#define BIT_APCPU_DVFS_APB_PERIPH_SEL_DVFS_HISTORY2(x)                ((x) << 20 & (BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_INDEX_HISTORY2(x)                 ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_SCU_DIV_DVFS_HISTORY2                      BIT(15)
#define BIT_APCPU_DVFS_APB_SCU_SEL_DVFS_HISTORY2(x)                   ((x) << 12 & (BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_MPLL_CPU2_INDEX_HISTORY2(x)                ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_CPU2_VOLTAGE_DVFS_HISTORY2(x)              ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CPU2_DIV_DVFS_HISTORY2                     BIT(3)
#define BIT_APCPU_DVFS_APB_CPU2_SEL_DVFS_HISTORY2(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_DVFS_HISTORY3_DEBUG_M, [0x64950470] */
#define BIT_APCPU_DVFS_APB_MPLL_CPU1_INDEX_HISTORY3(x)                ((x) << 20 & (BIT(20) | BIT(21) | BIT(22) | BIT(23)))
#define BIT_APCPU_DVFS_APB_CPU1_VOLTAGE_DVFS_HISTORY3(x)              ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_CPU1_DIV_DVFS_HISTORY3                     BIT(15)
#define BIT_APCPU_DVFS_APB_CPU1_SEL_DVFS_HISTORY3(x)                  ((x) << 12 & (BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_MPLL_CPU0_INDEX_HISTORY3(x)                ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_CPU0_VOLTAGE_DVFS_HISTORY3(x)              ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CPU0_DIV_DVFS_HISTORY3                     BIT(3)
#define BIT_APCPU_DVFS_APB_CPU0_SEL_DVFS_HISTORY3(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_DVFS_HISTORY3_DEBUG_L, [0x64950474] */
#define BIT_APCPU_DVFS_APB_GIC_DIV_DVFS_HISTORY3(x)                   ((x) << 27 & (BIT(27) | BIT(28) | BIT(29)))
#define BIT_APCPU_DVFS_APB_GIC_SEL_DVFS_HISTORY3(x)                   ((x) << 25 & (BIT(25) | BIT(26)))
#define BIT_APCPU_DVFS_APB_PERIPH_DIV_DVFS_HISTORY3(x)                ((x) << 22 & (BIT(22) | BIT(23) | BIT(24)))
#define BIT_APCPU_DVFS_APB_PERIPH_SEL_DVFS_HISTORY3(x)                ((x) << 20 & (BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_INDEX_HISTORY3(x)                 ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_SCU_DIV_DVFS_HISTORY3                      BIT(15)
#define BIT_APCPU_DVFS_APB_SCU_SEL_DVFS_HISTORY3(x)                   ((x) << 12 & (BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_MPLL_CPU2_INDEX_HISTORY3(x)                ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_CPU2_VOLTAGE_DVFS_HISTORY3(x)              ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CPU2_DIV_DVFS_HISTORY3                     BIT(3)
#define BIT_APCPU_DVFS_APB_CPU2_SEL_DVFS_HISTORY3(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_DVFS_HISTORY4_DEBUG_M, [0x64950478] */
#define BIT_APCPU_DVFS_APB_MPLL_CPU1_INDEX_HISTORY4(x)                ((x) << 20 & (BIT(20) | BIT(21) | BIT(22) | BIT(23)))
#define BIT_APCPU_DVFS_APB_CPU1_VOLTAGE_DVFS_HISTORY4(x)              ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_CPU1_DIV_DVFS_HISTORY4                     BIT(15)
#define BIT_APCPU_DVFS_APB_CPU1_SEL_DVFS_HISTORY4(x)                  ((x) << 12 & (BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_MPLL_CPU0_INDEX_HISTORY4(x)                ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_CPU0_VOLTAGE_DVFS_HISTORY4(x)              ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CPU0_DIV_DVFS_HISTORY4                     BIT(3)
#define BIT_APCPU_DVFS_APB_CPU0_SEL_DVFS_HISTORY4(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_DVFS_HISTORY4_DEBUG_L, [0x6495047C] */
#define BIT_APCPU_DVFS_APB_GIC_DIV_DVFS_HISTORY4(x)                   ((x) << 27 & (BIT(27) | BIT(28) | BIT(29)))
#define BIT_APCPU_DVFS_APB_GIC_SEL_DVFS_HISTORY4(x)                   ((x) << 25 & (BIT(25) | BIT(26)))
#define BIT_APCPU_DVFS_APB_PERIPH_DIV_DVFS_HISTORY4(x)                ((x) << 22 & (BIT(22) | BIT(23) | BIT(24)))
#define BIT_APCPU_DVFS_APB_PERIPH_SEL_DVFS_HISTORY4(x)                ((x) << 20 & (BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_INDEX_HISTORY4(x)                 ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_SCU_DIV_DVFS_HISTORY4                      BIT(15)
#define BIT_APCPU_DVFS_APB_SCU_SEL_DVFS_HISTORY4(x)                   ((x) << 12 & (BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_MPLL_CPU2_INDEX_HISTORY4(x)                ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_CPU2_VOLTAGE_DVFS_HISTORY4(x)              ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CPU2_DIV_DVFS_HISTORY4                     BIT(3)
#define BIT_APCPU_DVFS_APB_CPU2_SEL_DVFS_HISTORY4(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_DVFS_HISTORY5_DEBUG_M, [0x64950480] */
#define BIT_APCPU_DVFS_APB_MPLL_CPU1_INDEX_HISTORY5(x)                ((x) << 20 & (BIT(20) | BIT(21) | BIT(22) | BIT(23)))
#define BIT_APCPU_DVFS_APB_CPU1_VOLTAGE_DVFS_HISTORY5(x)              ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_CPU1_DIV_DVFS_HISTORY5                     BIT(15)
#define BIT_APCPU_DVFS_APB_CPU1_SEL_DVFS_HISTORY5(x)                  ((x) << 12 & (BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_MPLL_CPU0_INDEX_HISTORY5(x)                ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_CPU0_VOLTAGE_DVFS_HISTORY5(x)              ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CPU0_DIV_DVFS_HISTORY5                     BIT(3)
#define BIT_APCPU_DVFS_APB_CPU0_SEL_DVFS_HISTORY5(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_APCPU_DVFS_APB_DVFS_HISTORY5_DEBUG_L, [0x64950484] */
#define BIT_APCPU_DVFS_APB_GIC_DIV_DVFS_HISTORY5(x)                   ((x) << 27 & (BIT(27) | BIT(28) | BIT(29)))
#define BIT_APCPU_DVFS_APB_GIC_SEL_DVFS_HISTORY5(x)                   ((x) << 25 & (BIT(25) | BIT(26)))
#define BIT_APCPU_DVFS_APB_PERIPH_DIV_DVFS_HISTORY5(x)                ((x) << 22 & (BIT(22) | BIT(23) | BIT(24)))
#define BIT_APCPU_DVFS_APB_PERIPH_SEL_DVFS_HISTORY5(x)                ((x) << 20 & (BIT(20) | BIT(21)))
#define BIT_APCPU_DVFS_APB_MPLL_SCU_INDEX_HISTORY5(x)                 ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_APCPU_DVFS_APB_SCU_DIV_DVFS_HISTORY5                      BIT(15)
#define BIT_APCPU_DVFS_APB_SCU_SEL_DVFS_HISTORY5(x)                   ((x) << 12 & (BIT(12) | BIT(13) | BIT(14)))
#define BIT_APCPU_DVFS_APB_MPLL_CPU2_INDEX_HISTORY5(x)                ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11)))
#define BIT_APCPU_DVFS_APB_CPU2_VOLTAGE_DVFS_HISTORY5(x)              ((x) << 4  & (BIT(4) | BIT(5) | BIT(6) | BIT(7)))
#define BIT_APCPU_DVFS_APB_CPU2_DIV_DVFS_HISTORY5                     BIT(3)
#define BIT_APCPU_DVFS_APB_CPU2_SEL_DVFS_HISTORY5(x)                  ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))
