...
#define REG_AON_APB_IST_CTRL                                                        SCI_ADDR(CTL_AON_APB_BASE, 0x0D40)
#define REG_AON_APB_THM_LIMIT_1                                                     SCI_ADDR(CTL_AON_APB_BASE, 0x0D44)
#define REG_AON_APB_THM_LIMIT_2                                                     SCI_ADDR(CTL_AON_APB_BASE, 0x0D48)
...
#define BIT_AON_APB_ARM_BOOT_MD4                                         BIT(11)
...
#define BIT_AON_APB_JITTER_MON_MPLL_LIT_SEL(x)                           ((x) << 17 & (BIT(17) | BIT(18) | BIT(19)))
...
/* bits definitions for REG_AON_APB_IST_CTRL, [0x64900D40] */
#define BIT_AON_APB_IST_EB                                               BIT(3)
#define BIT_AON_APB_IST_SOFT_PCLK_RST                                    BIT(2)
#define BIT_AON_APB_IST_SOFT_FUNCLK_RST                                  BIT(1)
#define BIT_AON_APB_IST_ENABLE_FROM_CPU                                  BIT(0)

/* bits definitions for REG_AON_APB_THM_LIMIT_1, [0x64900D44] */
#define BIT_AON_APB_CORE2_THM_LIMIT_EN                                   BIT(21)
#define BIT_AON_APB_CORE1_THM_LIMIT_EN                                   BIT(20)
#define BIT_AON_APB_CORE2_THM_VALUE(x)                                   ((x) << 10 & (BIT(10) | BIT(11) | BIT(12) | BIT(13) | BIT(14) | BIT(15) | BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_AON_APB_CORE1_THM_VALUE(x)                                   ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6) | BIT(7) | BIT(8) | BIT(9)))

/* bits definitions for REG_AON_APB_THM_LIMIT_2, [0x64900D48] */
#define BIT_AON_APB_CORE4_THM_LIMIT_EN                                   BIT(21)
#define BIT_AON_APB_CORE3_THM_LIMIT_EN                                   BIT(20)
#define BIT_AON_APB_CORE4_THM_VALUE(x)                                   ((x) << 10 & (BIT(10) | BIT(11) | BIT(12) | BIT(13) | BIT(14) | BIT(15) | BIT(16) | BIT(17) | BIT(18) | BIT(19)))
#define BIT_AON_APB_CORE3_THM_VALUE(x)                                   ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6) | BIT(7) | BIT(8) | BIT(9)))
