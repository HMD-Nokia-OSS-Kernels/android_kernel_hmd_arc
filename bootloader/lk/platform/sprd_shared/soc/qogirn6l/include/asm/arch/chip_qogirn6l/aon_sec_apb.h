...
#define REG_AON_SEC_APB_APCPU_CPS_CTRL                                        SCI_ADDR(CTL_AON_SEC_APB_BASE, 0x0064)
...
#define REG_AON_SEC_APB_APCPU_A55_CLK_CFG                                     SCI_ADDR(CTL_AON_SEC_APB_BASE, 0x002C)
#define REG_AON_SEC_APB_APCPU_A76_CLK_CFG                                     SCI_ADDR(CTL_AON_SEC_APB_BASE, 0x0030)
...
/* bits definitions for REG_AON_SEC_APB_APCPU_CPS_CTRL, [0x64820064] */
#define BIT_AON_SEC_APB_CGM_CPS_DIV(x)                ((x) << 4  & (BIT(4) | BIT(5) | BIT(6)))
#define BIT_AON_SEC_APB_CGM_CPS_SEL(x)                ((x) << 0  & (BIT(0) | BIT(1)))
...
/* bits definitions for REG_AON_SEC_APB_APCPU_A55_CLK_CFG, [0x6482002C] */
#define BIT_AON_SEC_APB_CGM_CORE3_DIV                 BIT(28)
#define BIT_AON_SEC_APB_CGM_CORE3_SEL(x)              ((x) << 24 & (BIT(24) | BIT(25) | BIT(26)))
#define BIT_AON_SEC_APB_CGM_CORE2_DIV                 BIT(20)
#define BIT_AON_SEC_APB_CGM_CORE2_SEL(x)              ((x) << 16 & (BIT(16) | BIT(17) | BIT(18)))
#define BIT_AON_SEC_APB_CGM_CORE1_DIV                 BIT(12)
#define BIT_AON_SEC_APB_CGM_CORE1_SEL(x)              ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_AON_SEC_APB_CGM_CORE0_DIV                 BIT(4)
#define BIT_AON_SEC_APB_CGM_CORE0_SEL(x)              ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_AON_SEC_APB_APCPU_A76_CLK_CFG, [0x64820030] */
#define BIT_AON_SEC_APB_CGM_CORE7_DIV                 BIT(28)
#define BIT_AON_SEC_APB_CGM_CORE7_SEL(x)              ((x) << 24 & (BIT(24) | BIT(25)))
#define BIT_AON_SEC_APB_CGM_CORE6_DIV                 BIT(20)
#define BIT_AON_SEC_APB_CGM_CORE6_SEL(x)              ((x) << 16 & (BIT(16) | BIT(17) | BIT(18)))
#define BIT_AON_SEC_APB_CGM_CORE5_DIV                 BIT(12)
#define BIT_AON_SEC_APB_CGM_CORE5_SEL(x)              ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_AON_SEC_APB_CGM_CORE4_DIV                 BIT(4)
#define BIT_AON_SEC_APB_CGM_CORE4_SEL(x)              ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_AON_SEC_APB_APCPU_BUS_CLK_CFG, [0x64820038] */
#define BIT_AON_SEC_APB_CGM_ACE_DIV                   BIT(12)
#define BIT_AON_SEC_APB_CGM_SCU_DIV                   BIT(4)
#define BIT_AON_SEC_APB_CGM_SCU_SEL(x)                ((x) << 0  & (BIT(0) | BIT(1) | BIT(2)))

/* bits definitions for REG_AON_SEC_APB_APCPU_TOP_MISC_CLK_CFG, [0x6482003C] */
