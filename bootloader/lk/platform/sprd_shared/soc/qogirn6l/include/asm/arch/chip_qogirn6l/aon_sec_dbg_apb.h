...
#define REG_AON_SEC_DBG_APB_POS_ONE_WRITE_FLAG_ADD0                           SCI_ADDR(CTL_AON_SEC_DBG_APB_BASE, 0x0044)
#define REG_AON_SEC_DBG_APB_POS_ONE_WRITE_FLAG_ADD1                           SCI_ADDR(CTL_AON_SEC_DBG_APB_BASE, 0x0048)
#define REG_AON_SEC_DBG_APB_POS_ONE_WRITE_FLAG_NON_SEC_ADD0                   SCI_ADDR(CTL_AON_SEC_DBG_APB_BASE, 0x004C)
#define REG_AON_SEC_DBG_APB_POS_ONE_WRITE_FLAG_NON_SEC_ADD1                   SCI_ADDR(CTL_AON_SEC_DBG_APB_BASE, 0x0050)
...
/* bits definitions for REG_AON_SEC_DBG_APB_POS_ONE_WRITE_FLAG_ADD0, [0x64890044] */
#define BIT_AON_SEC_DBG_APB_POS_ONE_WRITE_FLAG_ADD0(x)             ((x))

/* bits definitions for REG_AON_SEC_DBG_APB_POS_ONE_WRITE_FLAG_ADD1, [0x64890048] */
#define BIT_AON_SEC_DBG_APB_POS_ONE_WRITE_FLAG_ADD1(x)             ((x))

/* bits definitions for REG_AON_SEC_DBG_APB_POS_ONE_WRITE_FLAG_NON_SEC_ADD0, [0x6489004C] */
#define BIT_AON_SEC_DBG_APB_POS_ONE_WRITE_FLAG_NON_SEC_ADD0(x)     ((x))

/* bits definitions for REG_AON_SEC_DBG_APB_POS_ONE_WRITE_FLAG_NON_SEC_ADD1, [0x64890050] */
#define BIT_AON_SEC_DBG_APB_POS_ONE_WRITE_FLAG_NON_SEC_ADD1(x)     ((x))
