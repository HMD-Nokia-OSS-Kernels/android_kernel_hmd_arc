...
#define BIT_REG_FW_AP_AHB_CHIP_ID_RD_SEC                              BIT(11)
#define BIT_REG_FW_AP_AHB_UFSHC_CTRL_STATUS_RD_SEC                    BIT(10)
#define BIT_REG_FW_AP_AHB_CACHE_UFS_RD_SEC                            BIT(9)
#define BIT_REG_FW_AP_AHB_CACHE_EMMC_SDIO_RD_SEC                      BIT(8)
#define BIT_REG_FW_AP_AHB_ASYNC_BRIDGE_DEBUG_SIGNAL_W_AP_RD_SEC       BIT(7)
#define BIT_REG_FW_AP_AHB_ASYNC_BRIDGE_DEBUG_SIGNAL_W_DISP_RD_SEC     BIT(6)
#define BIT_REG_FW_AP_AHB_ASYNC_BRIDGE_DEBUG_SIGNAL_W_VDSP_RD_SEC     BIT(5)
#define BIT_REG_FW_AP_AHB_ASYNC_BRIDGE_IDLE_OVERFLOW_RD_SEC           BIT(4)
#define BIT_REG_FW_AP_AHB_AP_QOS1_RD_SEC                              BIT(3)
#define BIT_REG_FW_AP_AHB_AP_QOS0_RD_SEC                              BIT(2)
#define BIT_REG_FW_AP_AHB_AP_URGENCY_RD_SEC                           BIT(1)
#define BIT_REG_FW_AP_AHB_S8_LPC_RD_SEC                               BIT(0)
...
#define BIT_REG_FW_AP_AHB_CHIP_ID_WR_SEC                              BIT(11)
#define BIT_REG_FW_AP_AHB_UFSHC_CTRL_STATUS_WR_SEC                    BIT(10)
#define BIT_REG_FW_AP_AHB_CACHE_UFS_WR_SEC                            BIT(9)
#define BIT_REG_FW_AP_AHB_CACHE_EMMC_SDIO_WR_SEC                      BIT(8)
#define BIT_REG_FW_AP_AHB_ASYNC_BRIDGE_DEBUG_SIGNAL_W_AP_WR_SEC       BIT(7)
#define BIT_REG_FW_AP_AHB_ASYNC_BRIDGE_DEBUG_SIGNAL_W_DISP_WR_SEC     BIT(6)
#define BIT_REG_FW_AP_AHB_ASYNC_BRIDGE_DEBUG_SIGNAL_W_VDSP_WR_SEC     BIT(5)
#define BIT_REG_FW_AP_AHB_ASYNC_BRIDGE_IDLE_OVERFLOW_WR_SEC           BIT(4)
#define BIT_REG_FW_AP_AHB_AP_QOS1_WR_SEC                              BIT(3)
#define BIT_REG_FW_AP_AHB_AP_QOS0_WR_SEC                              BIT(2)
#define BIT_REG_FW_AP_AHB_AP_URGENCY_WR_SEC                           BIT(1)
#define BIT_REG_FW_AP_AHB_S8_LPC_WR_SEC                               BIT(0)
