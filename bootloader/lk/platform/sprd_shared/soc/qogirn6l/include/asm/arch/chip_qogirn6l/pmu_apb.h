...
#define REG_PMU_APB_MPLLMID1_REL_CFG                                                  SCI_ADDR(CTL_PMU_APB_BASE, 0x0A00)
...
#define REG_PMU_APB_MPLLMID1_RST_CTRL_CFG                                             SCI_ADDR(CTL_PMU_APB_BASE, 0x0AC0)
...
#define REG_PMU_APB_MULTI_CORE_WAKEUP_CTL                                             SCI_ADDR(CTL_PMU_APB_BASE, 0x0FB8)
#define REG_PMU_APB_MIDDLE_CORES_PSW_CTL                                              SCI_ADDR(CTL_PMU_APB_BASE, 0x0FBC)
...
#define BIT_PMU_APB_CORINTH_ON_DISABLE                                    BIT(8)
...
#define BIT_PMU_APB_PUB_DFS_FRQ_SEL_LOCK_PRE(x)                           ((x) << 9  & (BIT(9) | BIT(10) | BIT(11)))
...
/* bits definitions for REG_PMU_APB_MPLLMID1_REL_CFG, [0x64910A00] */
#define BIT_PMU_APB_MPLLMID1_REF_SEL(x)                                   ((x) << 27 & (BIT(27) | BIT(28) | BIT(29)))
#define BIT_PMU_APB_MPLLMID1_TOP_DVFS_SEL                                 BIT(25)
#define BIT_PMU_APB_MPLLMID1_PUB_SEL                                      BIT(21)
#define BIT_PMU_APB_MPLLMID1_CDMA2PMU_AUTO_SEL                            BIT(20)
#define BIT_PMU_APB_MPLLMID1_CDMA_AUTO_SEL                                BIT(19)
#define BIT_PMU_APB_MPLLMID1_CDMA_PROC0_SEL                               BIT(18)
#define BIT_PMU_APB_MPLLMID1_CH_SEL                                       BIT(11)
#define BIT_PMU_APB_MPLLMID1_SP_SEL                                       BIT(10)
#define BIT_PMU_APB_MPLLMID1_IPA_SEL                                      BIT(6)
#define BIT_PMU_APB_MPLLMID1_AUDIO_SEL                                    BIT(5)
#define BIT_PMU_APB_MPLLMID1_PHY_CP_SEL                                   BIT(4)
#define BIT_PMU_APB_MPLLMID1_PS_CP_SEL                                    BIT(3)
#define BIT_PMU_APB_MPLLMID1_AP_SEL                                       BIT(2)
#define BIT_PMU_APB_MPLLMID1_FRC_OFF                                      BIT(1)
#define BIT_PMU_APB_MPLLMID1_FRC_ON                                       BIT(0)
...
#define BIT_PMU_APB_MPLLMID1_WAIT_CNT(x)                                  ((x) << 24 & (BIT(24) | BIT(25) | BIT(26) | BIT(27) | BIT(28) | BIT(29) | BIT(30) | BIT(31)))
...
/* bits definitions for REG_PMU_APB_MPLLMID1_RST_CTRL_CFG, [0x64910AC0] */
#define BIT_PMU_APB_MPLLMID1_RST_CTRL_BYPASS                              BIT(24)
#define BIT_PMU_APB_MPLLMID1_DELAY_PWR_ON(x)                              ((x) << 16 & (BIT(16) | BIT(17) | BIT(18) | BIT(19) | BIT(20) | BIT(21) | BIT(22) | BIT(23)))
#define BIT_PMU_APB_MPLLMID1_DELAY_EN_OFF(x)                              ((x) << 8  & (BIT(8) | BIT(9) | BIT(10) | BIT(11) | BIT(12) | BIT(13) | BIT(14) | BIT(15)))
#define BIT_PMU_APB_MPLLMID1_DELAY_RST_ASSERT(x)                          ((x) << 0  & (BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6) | BIT(7)))
...
#define BIT_PMU_APB_ST_MPLLMID1_STATE(x)                                  ((x) << 12 & (BIT(12) | BIT(13) | BIT(14) | BIT(15)))
...
/* bits definitions for REG_PMU_APB_MULTI_CORE_WAKEUP_CTL, [0x64910FB8] */
#define BIT_PMU_APB_TIMEOUT_THR(x)                                        ((x) << 2  & (BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6) | BIT(7) | BIT(8) | BIT(9) | BIT(10) | BIT(11) | BIT(12) | BIT(13) | BIT(14) | BIT(15) | BIT(16) | BIT(17)))
#define BIT_PMU_APB_TIMER_EN                                              BIT(1)
#define BIT_PMU_APB_MULTI_CORE_WAKE_SW_EN                                 BIT(0)

/* bits definitions for REG_PMU_APB_MIDDLE_CORES_PSW_CTL, [0x64910FBC] */
#define BIT_PMU_APB_PD_APCPU_CORE7_SHUTDOWN_M_B                           BIT(3)
#define BIT_PMU_APB_PD_APCPU_CORE7_SHUTDOWN_D_B                           BIT(2)
#define BIT_PMU_APB_PD_APCPU_CORE6_SHUTDOWN_M_B                           BIT(1)
#define BIT_PMU_APB_PD_APCPU_CORE6_SHUTDOWN_D_B                           BIT(0)
