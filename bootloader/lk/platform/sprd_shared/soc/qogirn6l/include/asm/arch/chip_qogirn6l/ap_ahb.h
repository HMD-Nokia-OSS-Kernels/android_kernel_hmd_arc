...
#define REG_AP_AHB_S8_LPC                                                          SCI_ADDR(CTL_AP_AHB_BASE, 0x00AC)
...
/* bits definitions for REG_AP_AHB_S8_LPC, [0x200000AC] */
#define BIT_AP_AHB_MAIN_S8_PU_NUM(x)                  ((x) << 24 & (BIT(24) | BIT(25) | BIT(26) | BIT(27) | BIT(28) | BIT(29) | BIT(30) | BIT(31)))
#define BIT_AP_AHB_CGM_MTX_S8_AUTO_GATE_EN            BIT(17)
#define BIT_AP_AHB_MAIN_S8_LP_EB                      BIT(16)
#define BIT_AP_AHB_MAIN_S8_LP_NUM(x)                  ((x) << 0  & (0x0000FFFF))
