...
#define CTL_AON_SYS_BASE                SCI_IOMAP(0x645A0480)
#endif

/* registers definitions for CTL_AON_SYS, 0x645A0480 */
...
/* bits definitions for REG_AON_SYS_REGU_OT_CTRL_EN, [0x645A0480] */
#define BIT_AON_SYS_OT_CTRL_EN                  BIT(0)

/* bits definitions for REG_AON_SYS_REGU_OT_CTRL_AW_CFG, [0x645A0484] */
...
/* bits definitions for REG_AON_SYS_REGU_OT_CTRL_AR_CFG, [0x645A0488] */
...
/* bits definitions for REG_AON_SYS_REGU_OT_CTRL_AX_CFG, [0x645A048C] */
...
/* bits definitions for REG_AON_SYS_REGU_LAT_EN, [0x645A0490] */
#define BIT_AON_SYS_REGU_EN_R                   BIT(1)
#define BIT_AON_SYS_REGU_EN_W                   BIT(0)

/* bits definitions for REG_AON_SYS_REGU_LAT_W_CFG, [0x645A0494] */
...
/* bits definitions for REG_AON_SYS_REGU_LAT_R_CFG, [0x645A0498] */
...
/* bits definitions for REG_AON_SYS_REGU_LAT_STATUS, [0x645A049C] */
...
/* bits definitions for REG_AON_SYS_REGU_AXQOS_GEN_EN, [0x645A04E0] */
#define BIT_AON_SYS_URGENCY_FEEDTHR             BIT(31)
#define BIT_AON_SYS_GEN_EN_R                    BIT(1)
#define BIT_AON_SYS_GEN_EN_W                    BIT(0)

/* bits definitions for REG_AON_SYS_REGU_AXQOS_GEN_CFG, [0x645A04E4] */
...
/* bits definitions for REG_AON_SYS_REGU_URG_CNT_CFG, [0x645A04E8] */
#define BIT_AON_SYS_CNT_SEL(x)                  ((x) << 8  & (BIT(8) | BIT(9) | BIT(10)))
#define BIT_AON_SYS_CNT_EN                      BIT(0)

/* bits definitions for REG_AON_SYS_REGU_URG_CNT_VALUE, [0x645A04EC] */
