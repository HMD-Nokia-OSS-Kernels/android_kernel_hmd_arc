...
/*sys debug attribute */
#define VS_DebugLinkStartup  0xD095
#define VS_DebugStates       0xD097

/* Uni-Pro other attributes */
#define VS_DEBUGSAVECONFIGTIME	0xD0A0

/* L2 timeout value */
#define DL_FC0ProtectionTimeOutVal_Default	0x1FFF
#define DL_TC0ReplayTimeOutVal_Default		0xFFFF
#define DL_AFC0ReqTimeOutVal_Default		0x7FFF
#define DL_FC1ProtectionTimeOutVal_Default	0x1FFF
#define DL_TC1ReplayTimeOutVal_Default		0xFFFF
#define DL_AFC1ReqTimeOutVal_Default		0x7FFF
...
/* bCurrentPowerMode */
#define UFS_POWERDOWN_POWER_MODE 0x33
#define UFS_POWERDOWN_PWR_MODE 0x3
...
struct lu_info_tbl {
	...
	uint8_t				cfg_bLUEnable;
	uint16_t			cfg_wLUMaxActiveHPBRegions;
	uint16_t			cfg_wHPBPinnedRegionStartIdx;
	uint16_t			cfg_wNumHPBPinnedRegions;
	uint64_t			dLUCapacity;
};
...
struct ufs_driver_info {
	...
	/* active trigger reconfig ufs */
	int		active_reconfig_ufs;
} ;
...
/* HPB MODE */
enum {
	BHPBCONTROL_HOST_MODE	= 0,
	BHPBCONTROL_DEVICE_MODE = 1,
};
