...
#define SPI_REG_SET(reg_addr,value)    spi_reg_write((unsigned short)(reg_addr), (unsigned short)(value))
#define SPI_REG_GET(reg_addr)           spi_reg_read((unsigned short)(reg_addr))
#endif
