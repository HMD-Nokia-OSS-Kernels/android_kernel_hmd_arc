...
static void dpu_config_dsc_param(struct dispc_context *ctx)
{
	...
	reg->dsc_grp_size = ctx->dsc_cfg.reg.dsc_grp_size;
	reg->dsc_slice_size = ctx->dsc_cfg.reg.dsc_slice_size;
	reg->dsc_cfg0 = ctx->dsc_cfg.reg.dsc_cfg0;
	reg->dsc_cfg1 = ctx->dsc_cfg.reg.dsc_cfg1;
	reg->dsc_cfg2 = ctx->dsc_cfg.reg.dsc_cfg2;
	reg->dsc_cfg3 = ctx->dsc_cfg.reg.dsc_cfg3;
	reg->dsc_cfg4 = ctx->dsc_cfg.reg.dsc_cfg4;
	reg->dsc_cfg5 = ctx->dsc_cfg.reg.dsc_cfg5;
	reg->dsc_cfg6 = ctx->dsc_cfg.reg.dsc_cfg6;
	reg->dsc_cfg7 = ctx->dsc_cfg.reg.dsc_cfg7;
	reg->dsc_cfg8 = ctx->dsc_cfg.reg.dsc_cfg8;
	reg->dsc_cfg9 = ctx->dsc_cfg.reg.dsc_cfg9;
	reg->dsc_cfg10 = ctx->dsc_cfg.reg.dsc_cfg10;
	reg->dsc_cfg11 = ctx->dsc_cfg.reg.dsc_cfg11;
	reg->dsc_cfg12 = ctx->dsc_cfg.reg.dsc_cfg12;
	reg->dsc_cfg13 = ctx->dsc_cfg.reg.dsc_cfg13;
	reg->dsc_cfg14 = ctx->dsc_cfg.reg.dsc_cfg14;
	reg->dsc_cfg15 = ctx->dsc_cfg.reg.dsc_cfg15;
	reg->dsc_cfg16 = ctx->dsc_cfg.reg.dsc_cfg16;
	...
	if (panel->dual_dsi_en) {
		...
		reg->dsc1_v_timing = (rgb->vsync << 0) |
			(rgb->vbp << 8) |
			(rgb->vfp << 20);
		reg->dsc1_grp_size = ctx->dsc_cfg.reg.dsc_grp_size;
		reg->dsc1_slice_size = ctx->dsc_cfg.reg.dsc_slice_size;
		reg->dsc1_cfg0 = ctx->dsc_cfg.reg.dsc_cfg0;
		reg->dsc1_cfg1 = ctx->dsc_cfg.reg.dsc_cfg1;
		reg->dsc1_cfg2 = ctx->dsc_cfg.reg.dsc_cfg2;
		reg->dsc1_cfg3 = ctx->dsc_cfg.reg.dsc_cfg3;
		reg->dsc1_cfg4 = ctx->dsc_cfg.reg.dsc_cfg4;
		reg->dsc1_cfg5 = ctx->dsc_cfg.reg.dsc_cfg5;
		reg->dsc1_cfg6 = ctx->dsc_cfg.reg.dsc_cfg6;
		reg->dsc1_cfg7 = ctx->dsc_cfg.reg.dsc_cfg7;
		reg->dsc1_cfg8 = ctx->dsc_cfg.reg.dsc_cfg8;
		reg->dsc1_cfg9 = ctx->dsc_cfg.reg.dsc_cfg9;
		reg->dsc1_cfg10 = ctx->dsc_cfg.reg.dsc_cfg10;
		reg->dsc1_cfg11 = ctx->dsc_cfg.reg.dsc_cfg11;
		reg->dsc1_cfg12 = ctx->dsc_cfg.reg.dsc_cfg12;
		reg->dsc1_cfg13 = ctx->dsc_cfg.reg.dsc_cfg13;
		reg->dsc1_cfg14 = ctx->dsc_cfg.reg.dsc_cfg14;
		reg->dsc1_cfg15 = ctx->dsc_cfg.reg.dsc_cfg15;
		reg->dsc1_cfg16 = ctx->dsc_cfg.reg.dsc_cfg16;

		if (panel->work_mode == SPRD_MIPI_MODE_CMD)
			reg->dsc1_ctrl = 0x2000010b;
		else
			reg->dsc1_ctrl = 0x2000040b;
...
static u32 hal_to_drm_format(u32 hal_format)
{
	...
	case SPRD_DRM_FORMAT_RGBA8888:
		return SPRD_DRM_FORMAT_ABGR8888;
	case SPRD_DRM_FORMAT_RGBX8888:
		return SPRD_DRM_FORMAT_XBGR8888;
	case SPRD_DRM_FORMAT_BGRA8888:
		return SPRD_DRM_FORMAT_ARGB8888;
	case SPRD_DRM_FORMAT_RGB888:
		return SPRD_DRM_FORMAT_BGR888;
/*
	case SPRD_DRM_FORMAT_RGB565:
		return SPRD_DRM_FORMAT_BGR565;
*/
	default:
		return hal_format;
	}
...
static u32 dpu_img_ctrl(u32 format, u32 blending, u32 compression)
{
	...
	/* need to convert the HAL_PIXEL_FORMAT* to SPRD_DRM_FORMAT* first */
...
static bool check_dpu_stop(struct dispc_context *ctx)
{
	u32 dpu_sts_21, dpu_sts_22;

	dpu_sts_21 = read32(ctx->base + REG_DPU_STS_21);
	dpu_sts_22 = read32(ctx->base + REG_DPU_STS_22);

	if ((dpu_sts_21 & BIT(15)) || (dpu_sts_22 & BIT(15))) {
		return false;
	} else {
...
static struct dispc_core_ops dpu_r6p1_ops = {
