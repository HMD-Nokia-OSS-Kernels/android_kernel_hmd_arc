/*
 *  <lcd_nt35532_truly_mipi_fhd.c> - <lcd nt35532 truly mipi fhd>
 *
...
static int nt35532_readid(struct panel_info *info)
{
	struct sprd_dsi *dsi = &dsi_device;
...
static int nt35532_sleep_in(void)
{
	struct sprd_dsi *dsi = &dsi_device;

	mipi_dsi_lp_cmd_enable(dsi, true);
	mipi_dsi_send_cmds(dsi, sleep_in_data);
	pr_info("nt35532_sleep_in end\n");
	return 0;
}
