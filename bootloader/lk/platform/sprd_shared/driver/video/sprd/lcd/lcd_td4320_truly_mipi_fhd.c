/*
 *  <lcd_td4320_truly_mipi_fhd.c> - <lcd td4320 mipi fhd>
 *
 *  Copyright (C) 2019 Unisoc Communications Inc.
 *  History:
 *      <2022-12-20> <jianzhong.wang@unisoc.com>
 *
...
static int td4320_sleep_in(void)
{
	struct sprd_dsi *dsi = &dsi_device;

	mipi_dsi_lp_cmd_enable(dsi, true);
	mipi_dsi_send_cmds(dsi, sleep_in_data);
	pr_info("td4320_sleep_in end\n");
	return 0;
}
