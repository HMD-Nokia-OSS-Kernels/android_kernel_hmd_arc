/*
 *  <lcd_ssd2092_truly_mipi_fhd.c> - <lcd ssd2092 truly mipi fhd>
 *
...
static int ssd2092_readid(struct panel_info *info)
{
	struct sprd_dsi *dsi = &dsi_device;
...
static int ssd2092_sleep_in(void)
{
	struct sprd_dsi *dsi = &dsi_device;
	struct sprd_dphy *dphy = &dphy_device;
