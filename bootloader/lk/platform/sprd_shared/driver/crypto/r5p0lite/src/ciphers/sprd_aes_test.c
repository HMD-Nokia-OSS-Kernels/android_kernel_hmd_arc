...
sprd_crypto_err_t sprd_aes_speed_test (void) {
	...
	int32_t aes_ecb = 0, aes_cbc = 0, aes_ctr = 0, aes_xts = 0;
...
sprd_crypto_err_t sprd_aes_test_kce (void) {
	...
	SPRD_CRYPTO_LOG_ERR("lk_kce_test start.\n");
	/* encrypt */
	...
	SPRD_CRYPTO_LOG_ERR("lk_kce_test success.\n");
...
sprd_crypto_err_t sprd_aes_test (void) {
	sprd_crypto_err_t err = SPRD_CRYPTO_SUCCESS;
	int32_t aes_ecb = 0, aes_cbc = 0, aes_ctr = 0, aes_xts = 0, aes_kce = 0, aes_ctr_hdcp = 0;
