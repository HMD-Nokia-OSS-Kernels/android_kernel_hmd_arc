...
{
	__raw_writel(BIT_AON_APB_MM_EB | BIT_AON_APB_GPU_EB |
	...
	//__raw_writel(BIT_CAMERASYS_GLB_CKG_EN, REG_CAMERASYS_GLB_MM_SYS_EN + 0x1000); //zebu_flash bitfile does not contain camera
