 ...
 *Version: UMS9230_6_IRD_A_SCH_V1.0.0_PINMAP_V1.020200928
 *Create Time: 2023/5/10 15:52:33
 *Author: fei.pan1
 */
...
{REG_MISC_PIN_RFCTL2,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//NC
...
{REG_MISC_PIN_DNS_D0,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_Z},//DNS_D0
{REG_PIN_DNS_D1,                        BITS_PIN_AF(1)},
{REG_MISC_PIN_DNS_D1,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_Z},//DNS_D1
...
{REG_MISC_PIN_SCL3,                     BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_IE},//WCHG_PG
...
/*here is the umb9230s pinmap */
static pinmap_t umb9230s_pinmap[]={
{REG_PIN_U2TXD,                 BITS_PIN_AF(3)},
{REG_MISC_PIN_U2TXD,            BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//GPIO171
{REG_PIN_U2RXD,                 BITS_PIN_AF(3)},
{REG_MISC_PIN_U2RXD,            BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_CM4|BIT_PIN_SLP_WPD|BIT_PIN_SLP_IE},//GPIO170
{REG_PIN_SPI2_CS1N,             BITS_PIN_AF(3)},
{REG_MISC_PIN_SPI2_CS1N,        BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//GPIO_172
{REG_PIN_SDA3,                  BITS_PIN_AF(0)},
{REG_MISC_PIN_SDA3,             BITS_PIN_DS(5)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_Z},//I2C3_SDA
{REG_PIN_SCL3,                  BITS_PIN_AF(0)},
{REG_MISC_PIN_SCL3,             BITS_PIN_DS(5)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_Z},//I2C3_SCL
};

int  umb9230s_pin_init(void)
{
	size_t i;
	for (i = 0; i < sizeof(umb9230s_pinmap)/sizeof(umb9230s_pinmap[0]); i++) {
		__raw_writel(umb9230s_pinmap[i].val, CTL_PIN_BASE + umb9230s_pinmap[i].reg);
	}
