...
#ifdef ZCFG_VOL_OF_VDDLDO1 //modify by wanbo 20250619 for VDDLDO1 vol customize ,default 1.8V
	regulator_set_voltage("vddldo1",ZCFG_VOL_OF_VDDLDO1);
#endif
#ifdef ZCFG_UFS31_USE_VDD25
	regulator_set_voltage("vddemmccore",2500);//2.5V
#endif
...
#ifndef ZCFG_UMS9230_ONLY_CLOSE_ETA355D
