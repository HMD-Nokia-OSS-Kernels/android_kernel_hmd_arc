...
{
	wait_mm_wakeup();
	__raw_writel(BIT_AON_APB_MM_EB | BIT_AON_APB_DPU_VSP_EB, REG_AON_APB_APB_EB0 + 0x1000);
...
void target_init(void) {
	...
	if(1) {
		...
		__raw_writel(0x10, 0x642e034c);//pwm1 pin func
		__raw_writel(0x82001, 0x642e074c);//pwm1 pin misc
