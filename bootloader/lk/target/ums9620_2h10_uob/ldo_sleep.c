...
void pmic_lowpower_config(uint32_t ddie_id,uint32_t adie_id)
{
	...
	ANA_REG_SET(REG_ANA_UMP9621_SLP_DCDC_LP_CTRL,
		    BIT_ANA_UMP9621_SLP_DCDC_BUCKBOOST_LP_EN |
		    0);
...
void sprd_pmu_lowpower_init(void)
{
	...
	CHIP_REG_SET(REG_ANLG_PHY_G1_ANALOG_BB_TOP_SINE_DRV_CTRL, value);
#endif
}
