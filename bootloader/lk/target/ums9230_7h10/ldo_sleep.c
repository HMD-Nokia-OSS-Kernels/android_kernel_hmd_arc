...
void DCDC_ldo_power_on(void)
{
	...
	regulator_enable("vddldo3");	/* FP NEED alway on*/
}
...
void pmic_lowpower_config(uint32_t gen_para)
{
	...
	ANA_REG_SET(ANA_REG_GLB_LDO_XTL_EN0,
		BIT_LDO_VDD18_DCXO_EXT_XTL0_EN |		//UMP518 VDDDCXO is always on
	...
	ANA_REG_SET(ANA_REG_GLB_TSX_CTRL0,
		...
		BIT_SLP_DCXO_26M_REF_OUT0_EN |		//WCN
		//BIT_SLP_DCXO_26M_REF_OUT1_EN |	//NC
		//BIT_SLP_DCXO_26M_REF_OUT2_EN |	//control by NFC
		BIT_SLP_DCXO_26M_REF_OUT3_EN |		//AP
		BIT_SLP_DCXO_26M_REF_OUT4_EN |		//CP
		BITS_DCXO_26M_REF_OUT_EN(REFOUT0_ON | REFOUT3_ON | REFOUT4_ON) |
		0
	);
	...
	ANA_REG_SET(ANA_REG_GLB_TSX_CTRL14,
		...
		//BIT_DCXO_LP_CAL_EN |
		BITS_DCXO_26M_REF_BUF_OUTPUT_BYPASS(0x4) |	//refout2 = bypass
		BITS_DCXO_26M_REF_BUF0_DRV_LEVEL_CTRL(0x6) |
		BITS_DCXO_26M_REF_BUF1_DRV_LEVEL_CTRL(0x6) |
		0
	);

	ANA_REG_SET(ANA_REG_GLB_TSX_CTRL4,
		BITS_DCXO_26M_REF_BUF2_DRV_LEVEL_CTRL(0x7) |
		...
		BITS_DCXO_26M_REF_BUF4_DRV_LEVEL_CTRL(0x5) |
		0
	);
