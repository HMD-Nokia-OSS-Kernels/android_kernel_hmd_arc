...
/* Tab A8 code for AX6300DEV-56 by maoruiqian at 20210823 start */
{REG_PIN_DSI_TE,                        BITS_PIN_AF(3)},
{REG_MISC_PIN_DSI_TE,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPU|BIT_PIN_SLP_OE},//PA_RSTN
/* Tab A8 code for AX6300DEV-56 by maoruiqian at 20210823 end */
...
/*Tab A8 code for SR-AX6300-01-287 by fengzhigang at 2021/08/18 start*/
{REG_PIN_SD2_D2,                        BITS_PIN_AF(3)},
{REG_MISC_PIN_SD2_D2,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//CAMERA_FLASH_SYNC,not used--modified 20190513
...
/*Tab A8 code for SR-AX6300-01-287 by fengzhigang at 2021/08/18 end*/
...
{REG_MISC_PIN_IIS3DI,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//GPIO112 Modem_1
{REG_PIN_IIS3DO,                        BITS_PIN_AF(3)},
{REG_MISC_PIN_IIS3DO,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//GPIO113 Modem_2
{REG_PIN_IIS3CLK,                       BITS_PIN_AF(3)},
{REG_MISC_PIN_IIS3CLK,                  BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//GPIO114 Modem_3
...
{REG_MISC_PIN_GPIO33,			BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//GPIO33 BOARD_ID1
...
/*Tab A8 code for AX6300DEV-20 by shiyingjie at 2021/08/10 start*/
...
{REG_MISC_PIN_RFFE1_SDA,                BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_ALL_CP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//PCC_RFEE_SDA1
/*Tab A8 code for AX6300DEV-20 by shiyingjie at 2021/08/10 end*/
...
{REG_MISC_PIN_KEYIN2,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPU|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPU|BIT_PIN_SLP_IE},//CAP_INT_N
...
{REG_MISC_PIN_CMPD2,                    BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//GPIO40 BOARD_ID2
{REG_PIN_CMRST2,                        BITS_PIN_AF(3)},
{REG_MISC_PIN_CMRST2,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//GPIO41 BOARD_ID3
/*Tab A8 code for SR-AX6300-01-282 by mayuhang at 2021/8/19 start*/
{REG_PIN_GPIO84,                        BITS_PIN_AF(3)},
{REG_MISC_PIN_GPIO84,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPU|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPU|BIT_PIN_SLP_IE},//HALL_INT
/*Tab A8 code for SR-AX6300-01-282 by mayuhang at 2021/8/19 end*/
...
{REG_MISC_PIN_IIS1DI,                   BITS_PIN_DS(0)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_IE},//IIS1-DATA-IN
{REG_PIN_IIS1DO,                        BITS_PIN_AF(0)},
{REG_MISC_PIN_IIS1DO,                   BITS_PIN_DS(0)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//IIS1-DATA-OUT
{REG_PIN_IIS1CLK,                       BITS_PIN_AF(0)},
{REG_MISC_PIN_IIS1CLK,                  BITS_PIN_DS(0)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//IIS1-SCK
{REG_PIN_IIS1LRCK,                      BITS_PIN_AF(0)},
{REG_MISC_PIN_IIS1LRCK,                 BITS_PIN_DS(0)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//IIS1-LRCK
/* Tab A8 code for AX6300DEV-56 by maoruiqian at 20210823 end */
...
{REG_MISC_PIN_MEMS_MIC_CLK0,            BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_IE},//WB_INT_0
{REG_PIN_MEMS_MIC_DATA0,                BITS_PIN_AF(3)},
{REG_MISC_PIN_MEMS_MIC_DATA0,           BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_NUL|BIT_PIN_SLP_OE},//WB_RST_0
...
{REG_MISC_PIN_MEMS_MIC_DATA1,           BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//GPIO97 Modem_0
/*Tab A8 code for SR-AX6300-01-287 by fengzhigang at 2021/08/18 start*/
...
{REG_MISC_PIN_SPI2_DO,                  BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//BB_U2RXD
{REG_PIN_SPI2_DI,                       BITS_PIN_AF(0)},
{REG_MISC_PIN_SPI2_DI,                  BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//BOARD_ID2
{REG_PIN_SPI2_CLK,                      BITS_PIN_AF(0)},
{REG_MISC_PIN_SPI2_CLK,                 BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_AP|BIT_PIN_SLP_WPD|BIT_PIN_SLP_Z},//MIPI_SWITCH_EN
/*Tab A8 code for SR-AX6300-01-287 by fengzhigang at 2021/08/18 end*/
