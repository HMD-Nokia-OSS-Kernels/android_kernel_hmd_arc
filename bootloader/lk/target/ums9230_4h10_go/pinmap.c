...
{REG_PIN_CTRL_REG5,0x00704A10},//pubcp_sim0_bd_eb;pubcp_sim1_bd_eb;ap_sdio0_bd_eb;ap_emmc_db_eb;sim0_det_sel->pbucp sim0;card_det_sel->ap sd0 card;aon_usb_audio_iis->audcp vbc iis2 path;pad->wcn_btwf_uart0;pad->pub_uart1;pad->wtlcp_wci2
