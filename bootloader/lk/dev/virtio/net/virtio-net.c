...
static void dump_feature_bits(uint32_t feature) {
    dprintf(INFO,"virtio-net host features (0x%x):", feature);
    if (feature & VIRTIO_NET_F_CSUM) dprintf(INFO," CSUM");
    if (feature & VIRTIO_NET_F_GUEST_CSUM) dprintf(INFO," GUEST_CSUM");
    if (feature & VIRTIO_NET_F_CTRL_GUEST_OFFLOADS) dprintf(INFO," CTRL_GUEST_OFFLOADS");
    if (feature & VIRTIO_NET_F_MAC) dprintf(INFO," MAC");
    if (feature & VIRTIO_NET_F_GSO) dprintf(INFO," GSO");
    if (feature & VIRTIO_NET_F_GUEST_TSO4) dprintf(INFO," GUEST_TSO4");
    if (feature & VIRTIO_NET_F_GUEST_TSO6) dprintf(INFO," GUEST_TSO6");
    if (feature & VIRTIO_NET_F_GUEST_ECN) dprintf(INFO," GUEST_ECN");
    if (feature & VIRTIO_NET_F_GUEST_UFO) dprintf(INFO," GUEST_UFO");
    if (feature & VIRTIO_NET_F_HOST_TSO4) dprintf(INFO," HOST_TSO4");
    if (feature & VIRTIO_NET_F_HOST_TSO6) dprintf(INFO," HOST_TSO6");
    if (feature & VIRTIO_NET_F_HOST_ECN) dprintf(INFO," HOST_ECN");
    if (feature & VIRTIO_NET_F_HOST_UFO) dprintf(INFO," HOST_UFO");
    if (feature & VIRTIO_NET_F_MRG_RXBUF) dprintf(INFO," MRG_RXBUF");
    if (feature & VIRTIO_NET_F_STATUS) dprintf(INFO," STATUS");
    if (feature & VIRTIO_NET_F_CTRL_VQ) dprintf(INFO," CTRL_VQ");
    if (feature & VIRTIO_NET_F_CTRL_RX) dprintf(INFO," CTRL_RX");
    if (feature & VIRTIO_NET_F_CTRL_VLAN) dprintf(INFO," CTRL_VLAN");
    if (feature & VIRTIO_NET_F_GUEST_ANNOUNCE) dprintf(INFO," GUEST_ANNOUNCE");
    if (feature & VIRTIO_NET_F_MQ) dprintf(INFO," MQ");
    if (feature & VIRTIO_NET_F_CTRL_MAC_ADDR) dprintf(INFO," CTRL_MAC_ADDR");
    dprintf(INFO,"\n");
}
