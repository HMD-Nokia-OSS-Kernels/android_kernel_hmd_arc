...
/* CNTHP AArch64 registers */
#define TIMER_REG_CNTHP_CTL  cnthp_ctl_el2
#define TIMER_REG_CNTHP_CVAL cnthp_cval_el2
#define TIMER_REG_CNTHP_TVAL cnthp_tval_el2
#define TIMER_REG_CNTHPCT    cntpct_el0
