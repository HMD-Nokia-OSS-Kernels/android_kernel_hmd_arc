...
MODULE_SRCS += \
	...
	$(LOCAL_DIR)/arm/vectors.S \
	$(LOCAL_DIR)/arm/sprd_cache.c

ifeq ($( ARM_WITH_MMU),1)
MODULE_SRCS += $(LOCAL_DIR)/arm/mmu.c
else
MODULE_SRCS += \
	$(LOCAL_DIR)/arm/mmu_lpae.c \
	$(LOCAL_DIR)/arm/cache_mmu_lpae.S
endif
...
# find the direct path to compiler-rt or libgcc.a for our particular multilib variant
ifeq ($(BSP_LK_CLANG_COMPILE), true)
LIBGCC := \
    $(patsubst %.a,%-android.a, $(shell $(TOOLCHAIN_PREFIX)clang $(GLOBAL_COMPILEFLAGS) $(ARCH_COMPILEFLAGS) $(THUMBCFLAGS) \
