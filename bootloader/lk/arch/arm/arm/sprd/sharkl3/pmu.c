...
void pmu_commom_config(void)
{
	...
	CHIP_REG_SET(REG_PMU_APB_SYS_SOFT_RST_CTRL0, BIT_PMU_APB_SOFT_RST_SEL(0x1c3));
	CHIP_REG_SET(REG_PMU_APB_MM_BUS_CTRL0,
		     BIT_PMU_APB_APMM_SYS_SRST_FRC_LP_REQ_DFT_SLV_EN   |
		     BIT_PMU_APB_APVSP_SYS_SRST_FRC_LP_REQ_DFT_SLV_EN  |
		     BIT_PMU_APB_APGPU_SYS_SRST_FRC_LP_REQ_DFT_SLV_EN  |
		     BIT_PMU_APB_APDISP_SYS_SRST_FRC_LP_REQ_DFT_SLV_EN |
		     0
	);
	CHIP_REG_OR(REG_PMU_APB_SLEEP_CTRL3,
		    BIT_PMU_APB_DISP_PWR_HS_ACK_EN   |
		    BIT_PMU_APB_MM_PWR_HS_ACK_EN     |
		    BIT_PMU_APB_MM_VSP_PWR_HS_ACK_EN |
		    BIT_PMU_APB_GPU_PWR_HS_ACK_EN
...
{
	if ( readl(REG_AON_APB_AON_VER_ID) == 0 ) {
		set_clk_mpll(arm_clk, 0);
		writel(readl(REG_APCPU_TOP_CLK_CORE_CGM_CORE0_CFG) | BIT_APCPU_TOP_CLK_CORE_CGM_CORE0_CFG_CGM_CORE0_SEL(6),REG_APCPU_TOP_CLK_CORE_CGM_CORE0_CFG);
		writel(readl(REG_APCPU_TOP_CLK_CORE_CGM_CORE1_CFG) | BIT_APCPU_TOP_CLK_CORE_CGM_CORE1_CFG_CGM_CORE1_SEL(6),REG_APCPU_TOP_CLK_CORE_CGM_CORE1_CFG);
		writel(readl(REG_APCPU_TOP_CLK_CORE_CGM_CORE2_CFG) | BIT_APCPU_TOP_CLK_CORE_CGM_CORE2_CFG_CGM_CORE2_SEL(6),REG_APCPU_TOP_CLK_CORE_CGM_CORE2_CFG);
		writel(readl(REG_APCPU_TOP_CLK_CORE_CGM_CORE3_CFG) | BIT_APCPU_TOP_CLK_CORE_CGM_CORE3_CFG_CGM_CORE3_SEL(6),REG_APCPU_TOP_CLK_CORE_CGM_CORE3_CFG);
	}
