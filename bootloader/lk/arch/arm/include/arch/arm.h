...
/* hyp mode registers by unisoc*/
GEN_CP15_REG_FUNCS(hcr, 4, c1, c1, 0);
GEN_CP15_REG_FUNCS(hdfar, 4, c6, c0, 0);
GEN_CP15_REG_FUNCS(hifar, 4, c6, c0, 2);
GEN_CP15_REG_FUNCS(hpfar, 4, c6, c0, 4);
GEN_CP15_REG_FUNCS(hsr, 4, c5, c2, 0);
