...
GLOBAL_DEFINES += \
	...
	PSCI_CPU_ON_AARCH64=0xC4000003UL \
	PSCI_CPU_OFF=0x84000002UL
...
LIBGCC := \
    $(patsubst %.a,%-android.a, $(shell $(TOOLCHAIN_PREFIX)clang $(GLOBAL_COMPILEFLAGS) $(ARCH_COMPILEFLAGS) \
