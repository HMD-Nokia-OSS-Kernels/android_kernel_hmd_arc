...
static QOS_REG_T nic400_ipa_main_mtx_mx_qos_list[] = {
	/*nic400_ipa_main_mtx_m4_qos_list*/
	...
	/*nic400_ipa_main_mtx_m5_qos_list*/
...
static QOS_REG_T ipa_apb_rf_qos_list[] = {
...
void ap_qos_cfg(void)
{
	...
	for(i = 0; i < ARRAY_SIZE(nic400_ipa_main_mtx_mx_qos_list); i++) {
	value = nic400_ipa_main_mtx_mx_qos_list[i].set_value &
			nic400_ipa_main_mtx_mx_qos_list[i].mask_value;
		CHIP_REG_SET(nic400_ipa_main_mtx_mx_qos_list[i].base_addr, value);
	}

	for(i = 0; i < ARRAY_SIZE(ipa_apb_rf_qos_list); i++) {
		value = ipa_apb_rf_qos_list[i].set_value &
			ipa_apb_rf_qos_list[i].mask_value;
                CHIP_REG_SET(ipa_apb_rf_qos_list[i].base_addr, value);
	}
