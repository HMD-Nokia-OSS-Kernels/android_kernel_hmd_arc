...
#define	CONFIG_DCDCSRAM0_DEEP_DROP_VOL	750
#define	CONFIG_DCDCPUB_DEEP_DROP_VOL	600
#define	CONFIG_DCDCCORE_DEEP_DROP_VOL	550

// PMU power on/off sequence
void pmu_sequence_config(void)
{
	/* Sharkl6pro ufs_phy_ram_ram_pd_en clear */
	CHIP_REG_AND(REG_PMU_APB_RAM_PD_EN_CTRL,
		     ~BIT_PMU_APB_UFS_PHY_RAM_RAM_PD_EN
	);
	/* Sharkl6pro reg_ram_pd_ufs_phy_ram clear */
	CHIP_REG_AND(REG_PMU_APB_UFS_PHY_RAM_RAM_CFG,
		     ~BIT_PMU_APB_REG_RAM_PD_UFS_PHY_RAM
	);
	...
	CHIP_REG_SET(REG_PMU_APB_PLL_WAIT_CNT_0,
		     BIT_PMU_APB_MPLLMID1_WAIT_CNT(7) |
	...
	CHIP_REG_SET(REG_PMU_APB_MPLLMID1_RST_CTRL_CFG,
		     //BIT_PMU_APB_MPLLMID1_RST_CTRL_BYPASS |
		     BIT_PMU_APB_MPLLMID1_DELAY_PWR_ON(52) |
		     BIT_PMU_APB_MPLLMID1_DELAY_EN_OFF(4) |
		     BIT_PMU_APB_MPLLMID1_DELAY_RST_ASSERT(26) |
		     0
	);
	...
	CHIP_REG_SET(REG_PMU_APB_PWR_CNT_WAIT_CFG_0,
		     ...
		     BIT_PMU_APB_PHY_CP_PWR_WAIT_CNT(8) |
		     BIT_PMU_APB_PS_CP_PWR_WAIT_CNT(8) |
	...
	CHIP_REG_SET(REG_PMU_APB_PWR_CNT_WAIT_CFG_2,
		     BIT_PMU_APB_CH_PWR_WAIT_CNT(8) |
		     BIT_PMU_APB_SP_PWR_WAIT_CNT(8) |
		     0
	);
...
void ap_lpc_config(void)
{
	...
	CHIP_REG_OR(REG_AP_AHB_S8_LPC, BIT_AP_AHB_MAIN_S8_LP_EB);
...
*/
	...
	CHIP_REG_OR(REG_AP_AHB_S7_LPC, BIT_AP_AHB_CGM_MTX_S7_AUTO_GATE_EN);
  	CHIP_REG_OR(REG_AP_AHB_MAIN_LPC, BIT_AP_AHB_CGM_MATRIX_AUTO_GATE_EN);
