...
void apcpu_hw_dvfs_config(void)
{
	...
	__raw_writel(BIT_TOP_DVFS_APB_DCDC_CPU1_VOLTAGE0_I2C(0x0f) |
		     BIT_TOP_DVFS_APB_DCDC_CPU1_VOLTAGE1_I2C(0x14) |
		     BIT_TOP_DVFS_APB_DCDC_CPU1_VOLTAGE2_I2C(0x19) |
		     BIT_TOP_DVFS_APB_DCDC_CPU1_VOLTAGE3_I2C(0x1e),
		     REG_TOP_DVFS_APB_DIALOG_DCDC_CPU1_DVFS_VOLTAGE_VALUE0);

	__raw_writel(BIT_TOP_DVFS_APB_DCDC_CPU1_VOLTAGE4_I2C(0x23) |
		     BIT_TOP_DVFS_APB_DCDC_CPU1_VOLTAGE5_I2C(0x28) |
		     BIT_TOP_DVFS_APB_DCDC_CPU1_VOLTAGE6_I2C(0x28) |
		     BIT_TOP_DVFS_APB_DCDC_CPU1_VOLTAGE7_I2C(0x28),
