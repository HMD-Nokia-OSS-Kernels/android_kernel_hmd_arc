...
static inline void arch_enable_async(void)
{
    CF;
    __asm__ volatile("msr daifclr, #4" ::: "memory");
}

static inline void arch_disable_async(void)
{
    __asm__ volatile("msr daifset, #4" ::: "memory");
    CF;
}

static inline void arch_enable_dbg(void)
{
    CF;
    __asm__ volatile("msr daifclr, #8" ::: "memory");
}

static inline void arch_disable_dbg(void)
{
...
static inline bool arch_async_disabled(void)
{
    unsigned int state;
...
static inline bool arch_dbg_disabled(void)
{
    unsigned int state;
...
static inline bool check_serror_status(void)
{
    uint64_t value;
    __asm__ volatile ("mrs %0, isr_el1"  : "=r" (value));
    value &= (1<<8);
...
static inline uint arch_curr_cpu_num(void) {
    ...
    cpu = (((mpidr & ((1U << SMP_CPU_ID_BITS) - 1)) >> 8 << SMP_CPU_CLUSTER_SHIFT) & 0xff);
