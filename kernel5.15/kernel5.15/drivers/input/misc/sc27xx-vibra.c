...
static int sc27xx_vibra_hw_init(struct vibra_info *info)
{
	...
	printk("ZCFG_VIBRATOR_VOLTAGE REG = %x\n",ZCFG_VIBRATOR_VOLTAGE);
	return regmap_update_bits(info->regmap, info->base, GENMASK(7, 0), ZCFG_VIBRATOR_VOLTAGE);
#else
